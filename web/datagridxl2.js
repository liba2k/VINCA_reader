...
var DataGridXL = function() {
    ...
    function r(t, e) {
        void 0 === e && (e = null),
        null != e && n(e) ? h.call(this, t, e) : i(t) ? a.call(this, t) : n(t) && c.call(this, t)
    }
    var l = function(t, e, i) {
        ...
        for (var o = !1, s = i, n = 0; n < t.length; n++) {
            ...
            var r = void 0
              , l = void 0;
            null != e && ("source"in t[n] ? t[n].source in e && (r = t[n].source,
            l = t[n].source) : (r = e[n] || void 0,
            l = e[n] || void 0));
            var h = t[n].field || r
              , a = t[n].title || l
              , c = t[n]._hide || !1;
        ...
        return o || (this._cols.store[this._cols.store.length - 1]._hide = !1),
        s
    }
      , h = function(t, e) {
        if (n(t))
            ...
            i = null;
        l.call(this, e, i);
        for (var o = [], s = 0; s < this._cols.store.length; s++)
            o.push(this._cols.store[s].id);
        this._cols.indexList = o,
        this._cols.store._lastId = this._cols.store[this._cols.store.length - 1].id
    }
      , a = function(t) {
    ...
    function u(t, e) {
        void 0 === e && (e = null),
        this._cellStore = [],
        null != e && n(e) ? i(t) ? p.call(this, t, e) : n(t) && g.call(this, t, e) : i(t) ? f.call(this, t) : n(t) && _.call(this, t)
    }
    var p = function(t, e) {
        for (var i = 0; i < this._rows.store.length; i++) {
            this._cellStore[this._rows.store[i].id - 1] = [];
            for (var o = 0; o < this._cols.store.length; o++) {
                if ("source"in e[o] && d(e[o].source))
                    var s = Number(e[o].source);
                else
                    s = o;
      ...
      , f = function(t) {
        for (var e = 0; e < this._rows.store.length; e++) {
            ...
            for (var i = 0; i < this._cols.store.length; i++)
                this._cellStore[this._rows.store[e].id - 1][this._cols.store[i].id - 1] = {
                    value: t[e][i],
                    _found: !1
                }
        }
    ...
    function y(t, e) {
        void 0 === t && (t = null),
        void 0 === e && (e = null),
        this._dataFormat = i(t) ? "arrayCollection" : "objectCollection",
        o.call(this, t),
        r.call(this, t, e),
        u.call(this, t, e)
    }
    ...
    function x() {
        var t = []
          ...
          , r = [[], [], []]
          , l = [[], [], []];
        if (null != this._freezeLineColAfterId)
            var h = 0;
        else
            h = 1;
        for (var a = 0; a < this._cols.indexList.length; a++) {
            this._cols.store[this._cols.indexList[a] - 1]._hide ? (n ? i[o].push(this._cols.indexList[a]) : (i[++o] = [this._cols.indexList[a]],
            e > 0 && (s[e - 1][1] = o)),
            n = !0) : (t.push(this._cols.indexList[a]),
            r[h].push(this._cols.indexList[a]),
            n ? s.push([o, null]) : s.push([null, null]),
            e++,
            n = !1),
            l[h].push(this._cols.indexList[a]),
            this._cols.indexList[a] == this._freezeLineColAfterId && (h = 1)
        }
        this._cols.hiddenGroups = i,
        this._cols.iconList = s,
        this._cols.coordList = t,
        this._cols.coordSections = r,
        this._cols.indexSections = l
    }
    function w() {
        var t = []
          , e = 0
          ...
          , r = [[], [], []]
          , l = [[], [], []];
        if (null != this._freezeLineRowAfterId)
            var h = 0;
        else
            h = 1;
        for (var a = 0; a < this._rows.indexList.length; a++) {
            var c = this._rows.store[this._rows.indexList[a] - 1];
            c._hide ? (n ? i[o].push(this._rows.indexList[a]) : (i[++o] = [this._rows.indexList[a]],
            e > 0 && (s[e - 1][1] = o)),
            n = !0) : c._pass && (t.push(this._rows.indexList[a]),
            r[h].push(this._rows.indexList[a]),
            n ? s.push([o, null]) : s.push([null, null]),
            e++,
            n = !1),
            l[h].push(this._rows.indexList[a]),
            this._rows.indexList[a] == this._freezeLineRowAfterId && (h = 1)
        }
        this._rows.hiddenGroups = i,
        this._rows.iconList = s,
        this._rows.coordList = t,
        this._rows.coordSections = r,
        this._rows.indexSections = l
    }
    function C(t) {
        for (var e = [], i = 0; i < t.length; i++)
            "string" == typeof t[i] ? !(t[i]in this._presetParts) || "include"in this._presetParts[t[i]] && !this._presetParts[t[i]].include.call(this) || e.push(this._presetParts[t[i]]) : e.push(t[i]);
        return e
    }
    function b(t) {
        S.call(this, t),
        ...
        x.call(this),
        w.call(this),
        this._validatedTopBar = C.call(this, this.topBar),
        this._validatedBottomBar = C.call(this, this.bottomBar)
    }
    var S = function(t) {
        for (var e in t)
      ...
      , I = function() {
        var t = this.frozenCols
          , e = this.frozenRows;
        this.frozenCols >= this._cols.indexList.length && (t = 0),
        this.frozenRows >= this._rows.indexList.length && (e = 0),
        this._freezeLineColAfterId = this._cols.indexList[t - 1] || null,
        this._freezeLineRowAfterId = this._rows.indexList[e - 1] || null
    };
    function R(t) {
        ...
        for (var o in e)
            if ("name" != o && "tag" != o && "domNodes" != o && "children" != o)
                if ("text" == o)
                    ...
                    var s = !0;
                    "_reset"in e && (s = e._reset),
                    P(i, e.style, s)
                } else
                    "noCSS" == o ? P(i, e.noCSS, !1) : "styleText" == o ? i.style.cssText = k(e.styleText) : o.startsWith("_") ? i[o] = e[o] : ("string" == typeof e[o] || d(e[o])) && i.setAttribute(o, e[o]);
        return i
    }
    function z() {
    ...
    function A(t, e) {
        void 0 === t && (t = null),
        void 0 === e && (e = []);
        for (var i = z(), o = 0; o < e.length; o++)
            null != e[o] && i.appendChild(e[o]);
        return t.appendChild(i),
        t
    }
    function T(t, e) {
        return void 0 === e && (e = this._domNodes),
        F.call(this, t, e)
    }
    var F = function(t, e) {
        if (void 0 === e && (e = null),
        ...
        var n = H(t.tag || "div", t);
        if ("domNodes"in t && t.domNodes.length && A(n, t.domNodes),
        "children"in t && t.children.length) {
            var r = [];
            for (s = 0; s < t.children.length; s++)
                "_reset"in t && (t.children[s]._reset = t._reset),
                r.push(F.call(this, t.children[s], e));
            A(n, r)
        }
        if (null != e && o.length) {
            var l = o[0].split(".");
            l.length > 1 ? (l[0]in e || (e[l[0]] = {}),
            e[l[0]][l[1]] = n) : e[o[0]] = n
        }
        return n
    };
    ...
    var X = function() {
      ...
      , Y = {
        ...
        ".dgxl-part button": function() {
            ...
            return "button"in this.theme || (t["background-image"] = "linear-gradient(#f7f8fa ,#e7e9ec)",
            t["border-color"] = "#adb1b8 #a2a6ac #8d9096"),
            t
        },
    ...
    function K(t, e) {
        for (; "classList"in t && !t.classList.contains(e); )
            t = t.parentNode;
    ...
    function j(t, e, i) {
        ...
        void 0 === i && (i = "#000"),
        "rgb" == t.substring(0, 3))
            var o = t.replace(/[^\d,.]/g, "").split(",")
              , s = o[0]
              , n = o[1]
              , r = o[2];
        else {
            var l = "#" === t.charAt(0) ? t.substring(1, 7) : t;
            s = parseInt(l.substring(0, 2), 16),
            n = parseInt(l.substring(2, 4), 16),
            r = parseInt(l.substring(4, 6), 16)
        }
    ...
    var U = function(t, e) {
        ...
        this._selectItemCallback = function() {}
        ,
        this._closeCallback = function() {}
        ,
        this.items = [],
        this._domNodes.containerNode = t
    };
    ...
    U.prototype.open = function(t, e, i, o, s, n) {
        ...
        for (var h = k(Y[".dgxl-contextMenuItemShortcutLabel"].call(this._context)), a = '<ul class="dgxl-contextMenuItemList" style="' + r + '">', c = 0; c < this.items.length; c++) {
            var d = "dgxl-contextMenuItem"
              , u = ""
              , p = !1;
            "disabled"in this.items[c] && this.items[c].disabled.call(this._context) ? (d += " " + d + "-disabled",
            u += "opacity:0.25;",
            p = !0) : u += "cursor:pointer;",
            a += '<li class="' + d + '" style="' + (l + u) + '"',
            a += p ? ' data-disabled="true"' : ' data-disabled="false"',
            a += ">";
            var f = R(this.items[c].label) ? this.items[c].label.call(this._context) : this.items[c].label;
            a += '<div class="dgxl-contextMenuItemLabel">' + this._context.getLocaleSetting(f) + "</div>",
            "shortcut"in this.items[c] && (a += '<div class="dgxl-contextMenuItemShortcutLabel" style="' + h + '">' + this.items[c].shortcut + "</div>"),
            a += "</li>"
        }
        a += "</ul>",
        Q.call(this, window, i, o),
        this._domNodes.containerNode.innerHTML = a,
        this._domNodes.containerNode.style.display = "block",
        this.setCursor(-1),
        "_mouseDownListener"in this._domNodes.containerNode || (this._domNodes.containerNode._mouseDownListener = function(t) {
        ...
        .bind(this)),
        "_contextMenuListener"in this._domNodes.containerNode || (this._domNodes.containerNode._contextMenuListener = function(t) {
            t.preventDefault()
        }
        ),
        document.addEventListener("mousedown", this._domNodes.containerNode._mouseDownListener),
        document.addEventListener("contextmenu", this._domNodes.containerNode._contextMenuListener),
        "_mouseMoveListener"in this._domNodes.containerNode || (this._domNodes.containerNode._mouseMoveListener = function(t) {
            var e = K(t.target, "dgxl-contextMenuItem");
            if (null == e || 1 == e.dataset.disabled)
                var i = -1;
            else
                i = W(e);
            this.setCursor(i)
        ...
        .bind(this)),
        "_mouseLeaveListener"in this._domNodes.containerNode || (this._domNodes.containerNode._mouseLeaveListener = function(t) {
            this.setCursor(-1)
        }
        .bind(this)),
        this._domNodes.containerNode.addEventListener("mousemove", this._domNodes.containerNode._mouseMoveListener),
        this._domNodes.containerNode.addEventListener("mouseleave", this._domNodes.containerNode._mouseLeaveListener)
    }
    ,
    ...
    U.prototype.execClose = function() {
        this._isOpen = !1,
        document.removeEventListener("mousedown", this._domNodes.containerNode._mouseDownListener),
        document.removeEventListener("contextmenu", this._domNodes.containerNode._contextMenuListener),
        this._domNodes.containerNode.removeEventListener("mousemove", this._domNodes.containerNode._mouseMoveListener),
        this._domNodes.containerNode.removeEventListener("mouseleave", this._domNodes.containerNode._mouseLeaveListener),
        this.setCursor(-1),
        this._domNodes.containerNode.innerHTML = "",
        this._domNodes.containerNode.style.display = "none"
    }
    ,
    U.prototype.setCursor = function(t) {
        if (t !== this._prevCursorIndex) {
            var e = this._domNodes.containerNode;
            e.children.length && (null !== this._prevCursorIndex && this._prevCursorIndex > -1 && (P(e.children[0].children[this._prevCursorIndex], Y["reset|.dgxl-contextMenuItem-highlight"].call(this._context)),
            e.children[0].children[this._prevCursorIndex].classList.remove("dgxl-contextMenuItem-highlight")),
            this._cursorIndex = t,
            null !== this._cursorIndex && this._cursorIndex > -1 && (P(e.children[0].children[this._cursorIndex], Y[".dgxl-contextMenuItem-highlight"].call(this._context)),
            e.children[0].children[this._cursorIndex].classList.add("dgxl-contextMenuItem-highlight")),
            this._prevCursorIndex = this._cursorIndex)
        }
    }
    ,
    ...
    ,
    U.prototype.moveCursorRight = function() {}
    ,
    U.prototype.moveCursorLeft = function() {}
    ,
    U.prototype.redrawLabels = function() {
        if (this.isOpen())
            for (var t = this._domNodes.containerNode.getElementsByClassName("dgxl-contextMenuItemList")[0], e = 0; e < this.items.length; e++)
                R(this.items[e].label) && (t.children[e].firstChild.innerHTML = this._context.getLocaleSetting(this.items[e].label.call(this._context)))
    }
    ,
    ...
    var q = function() {
      ...
      , Q = function(t, e, i) {
        ...
        if (o.style.width = n + "px",
        t == window)
            var r = window.scrollY + window.innerHeight
              , l = window.scrollX + window.innerWidth;
        else if (t instanceof Element) {
            var h = t.getBoundingClientRect();
            r = Math.floor(window.scrollY + h.y + h.height),
            l = Math.floor(window.scrollX + h.x + h.width)
        }
        i + this._offsetY + s > r ? o._top = i - (s + this._offsetY) : o._top = i + this._offsetY,
        e + this._offsetX + n > l ? o._left = e - (n + this._offsetX) : o._left = e + this._offsetX,
    ...
    var tt = function() {
        null === this._container ? this._domNodes.container = null : this._container instanceof HTMLElement ? this._domNodes.container = this._container : this._domNodes.container = document.getElementById(this._container),
        null === this._container ? T.call(this, O.call(this)) : this._domNodes.container.innerHTML = ""
    }
      , et = function() {
        Object.keys(this.constructor._domNodes).length || (A(document.body, [T.call(this, E.call(this), this.constructor._domNodes), T.call(this, M.call(this), this.constructor._domNodes), T.call(this, B.call(this), this.constructor._domNodes)]),
        this.constructor.contextMenu = new U(this.constructor._domNodes.contextMenu))
    }
      , it = function() {
        A(document.body, [T.call(this, D.call(this)), T.call(this, V.call(this))]),
        this._textWidthMeterCanvasContext = this._domNodes.textWidthMeterCanvas.getContext("2d"),
        this._textWidthMeterCanvasContext.font = this.fontSize + "px " + this.fontFamily
    }
      , ot = function() {
    ...
    function rt() {
        ...
        this._cd.containerWidth = this._domNodes.container.clientWidth - (parseFloat(e.paddingLeft) + parseFloat(e.paddingRight)),
        this._cd.containerHeight = this._domNodes.container.clientHeight - (parseFloat(e.paddingTop) + parseFloat(e.paddingBottom)),
        0 == this._containerHeight && (this._domNodes.container.style.height = "300px",
        t = !0),
        0 == this._containerWidth && (this._domNodes.container.style.width = "100%"),
        "static" == e.position && (this._domNodes.container.style.position = "relative"),
        "inline" == e.display && (this._domNodes.container.style.display = "inline-block",
        t = !0),
        "hidden" != e.overflow && (this._domNodes.container.style.overflow = "hidden"),
        t && (e = window.getComputedStyle(this._domNodes.container),
        this._cd.containerWidth = this._domNodes.container.clientWidth - (parseFloat(e.paddingLeft) + parseFloat(e.paddingRight)),
        this._cd.containerHeight = this._domNodes.container.clientHeight - (parseFloat(e.paddingTop) + parseFloat(e.paddingBottom)))
    }
    function lt() {
        return this.topBar && this.topBar.length ? 48 : 0
    }
    function ht() {
        return this.bottomBar && this.bottomBar.length ? 48 : 0
    }
    function at() {
    ...
    function vt(t) {
        for (var e = 0, i = t[0]; i <= t[1]; i++)
            e += this.getColWidthById(this.getColIdByCoord(i));
        return e
    }
    function mt() {
    ...
    function xt(t) {
        for (var e = 0, i = t[0]; i <= t[1]; i++)
            e += this.getRowHeightById(this.getRowIdByCoord(i));
        return e
    }
    function wt() {
    ...
    function Ct() {
        for (var t = this._cd.rowHeaderSpace, e = 0; e < this._sectionsPerPaneX.left.length; e++)
            t += bt.call(this, this._sectionsPerPaneX.left[e]);
        var i = t;
    ...
    var bt = function(t) {
        for (var e = 0, i = 0; i < this._cols.coordSections.length && !(i >= t); i++)
            e += this._cols.coordSections[i].length;
        var o = e + this._cols.coordSections[t].length - 1;
        return vt.call(this, [e, o])
    };
    function St() {
        for (var t = this._cd.colHeaderSpace, e = 0; e < this._sectionsPerPaneY.top.length; e++)
            t += It.call(this, this._sectionsPerPaneY.top[e]);
        var i = t;
    ...
    var It = function(t) {
        for (var e = 0, i = 0; i < this._rows.coordSections.length && !(i >= t); i++)
            e += this._rows.coordSections[i].length;
    ...
    var Lt = function(t) {
        for (var e = this._sectionsPerPaneY[t], i = [], o = 0; o < e.length; o++)
            i.push(this._rows.coordSections[e[o]]);
    ...
    var Nt = function(t) {
        for (var e = this._sectionsPerPaneX[t], i = [], o = 0; o < e.length; o++)
            i.push(this._cols.coordSections[e[o]]);
        return [].concat.apply([], i)
    };
    function kt() {
        for (var t = 0, e = 0; e < this._panesXids.center.length; e++)
            t += this.getColWidthById(this._panesXids.center[e]);
        return t
    }
    function Ht() {
        for (var t = 0, e = 0; e < this._panesYids.center.length; e++)
            t += this.getRowHeightById(this._panesYids.center[e]);
        return t
    }
    function zt() {
        for (var t, e, i = this._cd.innerDocumentWidth - this._cd.panesX.center.space, o = 0, s = 0; s < this._panesXids.center.length && (t = s,
        e = o,
        !(o >= i)); s++)
            o += this.getColWidthById(this._panesXids.center[s]);
    ...
    function At() {
        for (var t, e, i = this._cd.innerDocumentHeight - this._cd.panesY.center.space, o = 0, s = 0; s < this._panesYids.center.length && (t = s,
        e = o,
        !(o >= i)); s++)
            o += this.getRowHeightById(this._panesYids.center[s]);
    ...
    function Bt() {
        if (this._isFullscreen) {
            ...
            this._cd.componentWidth = this._domNodes.component.clientWidth,
            this._cd.componentHeight = this._domNodes.component.clientHeight
        } else
            this._cd.componentWidth = this._cd.containerWidth,
            this._cd.componentHeight = this._cd.containerHeight;
        this._cd.topBarSpace = lt.call(this),
        this._cd.bottomBarSpace = ht.call(this),
        this._cd.displayWidth = at.call(this),
        this._cd.displayHeight = ct.call(this),
        this._cd.scrollbarSpace = dt.call(this),
        this._cd.viewportWidth = ut.call(this),
        this._cd.viewportHeight = pt.call(this),
        this._cd.colHeaderLevelsSpace = gt.call(this),
        this._cd.rowHeaderLevelsSpace = ft.call(this),
        this._cd.colHeaderSpace = _t.call(this),
        this._cd.rowHeaderSpace = yt.call(this),
        this._cd.virtualPanesX = mt.call(this),
        this._cd.virtualPanesY = wt.call(this),
        this._cd.virtualPanesX.center >= 200 ? this._sectionsPerPaneX = {
            left: [0],
            center: [1]
        ...
        this._panesXids = Pt.call(this),
        this._panesYids = Rt.call(this),
        this._cd.panesX = Ct.call(this),
        this._cd.panesY = St.call(this),
        this._cd.innerDocumentWidth = kt.call(this),
        this._cd.innerDocumentHeight = Ht.call(this),
        this._lastColView = zt.call(this),
        this._lastRowView = At.call(this),
        this._cd.scrollAreaWidth = this._cd.displayWidth,
        this._cd.scrollAreaHeight = this._cd.displayHeight,
        this._cd.scrollWidth = Tt.call(this),
        this._cd.scrollHeight = Ft.call(this),
        this._cd.scrollableDocumentWidth = Et.call(this),
        this._cd.scrollableDocumentHeight = Mt.call(this)
    }
    function Ot() {
        for (var t = this._viewportPosition.x - this._panesXids.left.length, e = [], i = 0, o = this._cd.panesX.center.space; i < o && !(t > this._panesXids.center.length - 1); )
            e.push(this._panesXids.center[t]),
            i += this.getColWidthById(this._panesXids.center[t]),
            t++;
        this._colViewOverflow = i - this._cd.panesX.center.space,
        this._colView = e
    }
    function Dt() {
        for (var t = this._viewportPosition.y - this._panesYids.top.length, e = [], i = 0, o = this._cd.panesY.center.space; i < o && !(t > this._panesYids.center.length - 1); )
            e.push(this._panesYids.center[t]),
            i += this.getRowHeightById(this._panesYids.center[t]),
            t++;
        this._rowViewOverflow = i - this._cd.panesY.center.space,
        this._rowView = e
    }
    function Vt(t, e) {
        void 0 === t && (t = !1),
        void 0 === e && (e = !1),
        null == this._viewportPosition && (this._viewportPosition = {
    ...
    function Xt() {
        null == this.constructor_browserScrollbarSize && st.call(this),
        this._isFullscreen || rt.call(this),
        nt.call(this),
        Bt.call(this),
        Vt.call(this)
    }
    ...
    Yt.prototype.dispatch = function(t, e, i) {
        ...
        if (void 0 === e && (e = {}),
        void 0 === i && (i = t),
        t != this._anyEvent && this.dispatch(this._anyEvent, e, t),
    ...
    var Kt = function(t, e) {
        ...
        this._context = e,
        this._domNodes = {},
        this._domNodes.container = t,
        this._resizeListener,
        this.events = new Yt(this),
        jt.call(this),
        Ut.call(this)
    }
      , jt = function() {
        ...
        t.appendChild(e),
        t.appendChild(i),
        this._domNodes.component.appendChild(t),
        this._domNodes.container.appendChild(this._domNodes.component)
    }
      , Ut = function() {
        var t = this
          , e = Wt((function(e) {
        ...
        var i = !0
          ...
          , l = function(e) {
            e.target == s && i ? i = !1 : e.target == n && o ? o = !1 : (t._resizeListener(),
            r())
        };
        r(),
    ...
    var Gt = function() {
        for (var t, e = [], i = 0; i < this._validatedTopBar.length; i++)
            (t = {
    ...
    var $t = function(e, i) {
        ...
        "left" == i && (o -= this._cd.rowHeaderSpace),
        "top" == e && (s -= this._cd.colHeaderSpace);
    ...
    function te(t) {
        var e = t.cloneNode(!0);
        return "_opacity"in t && (e._opacity = t._opacity),
        "_borderStyle"in t && (e._borderStyle = t._borderStyle),
        e
    }
    function ee() {
        return {
    ...
    var re = function() {
      ...
      , le = function() {
        var t = [];
        for (var e in this._cd.panesY)
            t.push.apply(t, he.call(this, e));
        return t
    }
      , he = function(t) {
        var e = []
      ...
      , ae = function() {
        var t = [];
        for (var e in this._cd.panesX)
            t.push.apply(t, ce.call(this, e));
        return t
    }
      , ce = function(t) {
        var e = []
    ...
    var fe = function() {
        ...
        if (this._rowView.length) {
            ...
            i += this._actualRowHeight + 1,
            t = (this._cd.viewportHeight - i) / 100
        }
        return {
      ...
      , ge = function() {
        ...
        if (this._colView.length) {
            ...
            i += this.getColWidthById(this._cols.coordList[e]) + 1,
            t = (this._cd.viewportWidth - i) / 100
        }
        return {
    ...
    var ve = function(t) {
        var e = []
          , i = 0;
        if ("left" == t && (e.push(this._domNodes.rowHeaderColumn),
        i += this._cd.rowHeaderSpace),
        "center" == t)
            var o = this._colView;
        else
        ...
        for (var s = 0; s < o.length; s++) {
            ...
            l.column.style.transform = "translateX(" + i + "px)",
            i += r.width,
            e.push(l.column)
        }
        return e
    ...
    var we = function() {
        if (this._sectionsPerPaneX.left.length || null == this._freezeLineColAfterId)
            var t = 1;
        else
            t = 0;
      ...
      , Ce = function() {
        if (this._sectionsPerPaneY.top.length || null == this._freezeLineRowAfterId)
            var t = 1;
        else
            t = 0;
        var e = this.getThemeSetting("freezeline-tip");
    ...
    var Xe = function() {
        for (var t, e = [], i = 0; i < this._validatedBottomBar.length; i++)
            (t = {
    ...
    function Ke(t) {
        var e = {};
        for (var i in this.headerLabelSeries)
            e[i] = this.headerLabelSeries[i].indexToLabel(t, this.headerLabelSeries[i]);
        return e
    }
    function je(t) {
    ...
    function qe(t) {
        for (var e, i, o = "", s = We(this._selection, {
            ...
            i = t[r],
            e = this.getRowCoordById(i);
            for (var l = 0; l < s.length; l++)
                if (!n && e >= s[l].range[0].y && e <= s[l].range[1].y) {
                    o += '<span style="color:' + this.getThemeSetting("header:selected|text") + ';">',
                    n = !0;
                    break
                }
            o += Ue.call(this, i) + "\n";
    ...
    function ti(t) {
        for (var e = "", i = 0; i < this._panesYids.top.length; i++)
            e += je(this._cellStore[this._panesYids.top[i] - 1][t - 1].value) + "\n";
        return e
    }
    function ei(t) {
        for (var e = "", i = 0; i < this._rowView.length; i++)
            e += je(this._cellStore[this._rowView[i] - 1][t - 1].value) + "\n";
        return e
    }
    function ii(t, e) {
        var i = e - 1;
    ...
    var oi = function(t, e) {
      ...
      , si = function(t, e) {
        ...
        return "center" == i.align ? (o["margin-left"] = "-100%",
        o["margin-right"] = "-100%",
        o["text-align"] = "center",
        s["margin-left"] = "-100%",
        s["margin-right"] = "-100%",
        s["text-align"] = "center") : "right" == i.align && (o.float = "right",
        o["text-align"] = "right",
        s.float = "right",
        s["text-align"] = "right"),
        {
    ...
    function ni() {
        for (var t = 0; t < this._cols.store.length; t++)
            ii.call(this, t, this._cols.store[t].id)
    }
    function ri() {
        return {
    ...
    function wi(t) {
        var e = this;
        void 0 === t && (t = !1),
        this.constructor._isIOS || (this.activeSheetDisplay && (this._domNodes.cellEditor.style.top = this.getRowPositionInViewport(this._cellCursorPosition.y) + "px",
        this._domNodes.cellEditor.style.left = this.getColPositionInViewport(this._cellCursorPosition.x) + "px"),
        t ? Ci.call(this, this._domNodes.cellEditorInputField) : setTimeout((function() {
    ...
    function bi() {
        "webkitCurrentFullScreenElement"in document ? Si.call(this, "webkitCurrentFullScreenElement") : Si.call(this, "fullscreenElement"),
        this.constructor._isTouchDevice || wi.call(this)
    }
    var Si = function(t) {
      ...
      , Ii = function() {
        ...
        vi.call(this),
        setTimeout((function() {
            mi.call(t, "window", "resize"),
            t._domNodes.container._resizeSensor.events.off("resize", t._listeners.container.resize)
        }
        ), 100),
        Li.call(this),
        this.events.dispatch("fullscreenenter")
    }
      , Ri = function() {
        var t = this;
        (this.constructor._isMacOS || this.constructor._isIOS) && (this._domNodes.component.style.height = this._cd.containerHeight + "px",
        this._domNodes.component.style.width = this._cd.containerWidth + "px"),
        this._isFullscreen = !1,
        vi.call(this),
        setTimeout((function() {
            xi.call(t, "window", "resize"),
            t._domNodes.container._resizeSensor.events.on("resize", t._listeners.container.resize)
        }
        ), 100),
        this._isActive && (Pi.call(this),
        this.events.dispatch("fullscreenleave"))
    }
      , Li = function() {
        this.constructor.contextMenu.isOpen() && this.constructor.contextMenu.close(),
        A(this._domNodes.component, [this.constructor._domNodes.contextMenu])
    }
      , Pi = function() {
        this.constructor.contextMenu.isOpen() && this.constructor.contextMenu.close(),
        A(document.body, [this.constructor._domNodes.contextMenu, this.constructor._domNodes.contextMenuTouch])
    };
    function Ni(t) {
        var e = this;
        setTimeout((function() {
    ...
    var zi = function(t) {
        var e = We(this._topBarNodes, {
          ...
          , o = e.concat(i);
        o.length && (t.preventDefault(),
        this.search(""),
        o[0].nodes.inputField.focus(),
        o[0].nodes.inputField.select())
    };
    function Ai(t) {
        this.deactivate()
    }
    ...
    var Xi = function(t) {
        var e, i, o, s = !1, n = !1, r = 0, l = this._cd.rowHeaderSpace, h = 0, a = [];
        for (e = 0; e < this._panesXids.left.length; e++)
            i = e,
            o = this.getColWidthById(this._panesXids.left[i]),
            i >= t[0].x && i <= t[1].x && (a.push({
                colIndex: i,
                visibleColIndex: r,
                visibleColOffset: l
            }),
            ...
            l += o,
            r++;
        for ((this._panesXids.left.length || this._freezeLineColAfterId && this._sectionsPerPaneX.left.length && !this._panesXids.left.length) && (l += 6),
        e = 0; e < this._colView.length; e++)
            i = this._viewportPosition.x + e,
            o = this.getColWidthById(this._colView[e]),
            e == this._colView.length - 1 && (o -= Math.max(this._colViewOverflow, 0)),
            i >= t[0].x && i <= t[1].x && (a.push({
                colIndex: i,
                visibleColIndex: r,
                visibleColOffset: l
      ...
      , Yi = function(t) {
        var e, i, o, s = !1, n = !1, r = 0, l = this._cd.colHeaderSpace, h = 0, a = [];
        for (e = 0; e < this._panesYids.top.length; e++)
            i = e,
            o = this.getRowHeightById(this._panesYids.top[i]),
            i >= t[0].y && i <= t[1].y && (a.push({
                rowIndex: i,
                visibleRowIndex: r,
                visibleRowOffset: l
            }),
            ...
            l += o,
            r++;
        for ((this._panesYids.top.length || this._freezeLineRowAfterId && this._sectionsPerPaneY.top.length && !this._panesYids.top.length) && (l += 6),
        e = 0; e < this._rowView.length; e++)
            i = this._viewportPosition.y + e,
            o = this.getRowHeightById(this._rowView[e]),
            e == this._rowView.length - 1 && (o -= Math.max(this._rowViewOverflow, 0)),
            i >= t[0].y && i <= t[1].y && (a.push({
                rowIndex: i,
                visibleRowIndex: r,
                visibleRowOffset: l
    ...
    function Wi(t, e) {
        ...
        if (null != e) {
            ...
            var o = Vi.call(this, e)
              ...
              , r = i
              , l = i;
            o.y.lineTop && 0 != o.x.size || (s = "none"),
            o.y.lineBottom && 0 != o.x.size || (n = "none"),
            o.x.lineLeft && 0 != o.y.size || (r = "none"),
            o.x.lineRight && 0 != o.y.size || (l = "none"),
            "_actionProperties"in e && "dragDirection"in e._actionProperties && ("up" == e._actionProperties.dragDirection ? n = "none" : "right" == e._actionProperties.dragDirection ? r = "none" : "down" == e._actionProperties.dragDirection ? s = "none" : "left" == e._actionProperties.dragDirection && (l = "none")),
            t.style["border-top-style"] = s,
            t.style["border-right-style"] = l,
            t.style["border-bottom-style"] = n,
            t.style["border-left-style"] = r,
            o.x.size += 2 * t._extra,
            o.y.size += 2 * t._extra,
            o.x.offset -= t._extra,
            o.y.offset -= t._extra;
            ...
            t.style.transform = h,
            t.style.width = o.x.size + "px",
            t.style.height = o.y.size + "px"
        } else
            t.style.opacity = 0
    }
    function Ki(t, e, i) {
        var o = this;
        void 0 === i && (i = {}),
        "cut" == t ? (this._cutRange = e,
        this._copyRange = null) : "copy" == t ? (this._copyRange = e,
        this._cutRange = null) : "fill" == t && (this._fillRange = e,
        null != this._fillRange && (this._fillRange._actionProperties = i)),
        requestAnimationFrame((function() {
            Wi.call(o, o._domNodes.copyRange, o._copyRange),
            Wi.call(o, o._domNodes.cutRange, o._cutRange),
            Wi.call(o, o._domNodes.fillRange, o._fillRange)
        }
        ))
    }
    function ji(t, e) {
        ...
        this.events.dispatch("beforecopy", t)) {
            if (null != this.constructor._clipboardObject && Ki.call(this, this.constructor._clipboardObject.type, null),
            Ki.call(this, "copy", t.cellRange),
            Di(i) && "\n" == t.text)
                var o = !0;
            else
                o = !1;
            ...
            Oi.call(this, e, t.text),
            this.events.dispatch("copy", t)
        }
    }
    function Ui(t, e) {
        void 0 === t && (t = {}),
        ...
        this.events.dispatch("beforecut", t)) {
            if (null != this.constructor._clipboardObject && Ki.call(this, this.constructor._clipboardObject.type, null),
            this.instantCut)
                this.clearCellValues(t.cellRange);
            else {
                if (Ki.call(this, "cut", t.cellRange),
                Di(i) && "\n" == t.text)
                    var o = !0;
                else
                    o = !1;
            ...
            Oi.call(this, e, t.text),
            this.events.dispatch("cut", t)
        }
    }
    function qi(t) {
        t.preventDefault(),
        "cut" == this._domNodes.cellEditor._actualCommand ? Ui.call(this, {}, t) : ("copy" == this._domNodes.cellEditor._actualCommand || null == this._domNodes.cellEditor._actualCommand && this.allowCopy) && ji.call(this, {}, t),
        this._domNodes.cellEditor._actualCommand = void 0
    }
    function Gi(t) {
        return void 0 === t && (t = ""),
        "" == t ? [[null]] : this.textParser.parse(t, {
            delimiter: "\t"
        }).data
    }
    function Zi(t, e) {
        if (void 0 === t && (t = {}),
        this.events.dispatch("beforepaste", t)) {
            var i = t.text;
            null != this.constructor._clipboardObject && "\n" == t.text && this.constructor._clipboardObject.isSingleEmptyCell && (i = ""),
            (i.endsWith("\n") || i.endsWith("\r")) && (i = i.replace(/(\r\n|\n|\r)+$/g, ""));
            var o = Gi.call(this, i);
            if (null != this.constructor._clipboardObject && this.constructor._clipboardObject.instance == this && "cut" == this.constructor._clipboardObject.type && i == this.constructor._clipboardObject.text)
                var s = !0;
            else
                s = !1;
            this.events.dispatch("paste", t),
            this.setCellValues(this._selection, o, !0, s)
        }
    }
    function $i(t) {
        t.preventDefault(),
        this.allowPaste && Qi.call(this, t)
    }
    var Qi = function(t) {
        if (this.constructor._isIE)
    ...
    function eo(t) {
        "edit" != this._domNodes.cellEditor._mode && (this._domNodes.cellEditor._mode = "edit",
        to.call(this, "inputModeEdit"))
    }
    function io() {
    ...
    function oo(t) {
        if ("contextMenuOpen" != this._activeKeyActionSet && this.allowEditCells && (t.target.selectionEnd != t.target.selectionStart + 1 || t.target != document.activeElement)) {
            if (this._isUndo || this._isRedo)
                return this._isUndo = !1,
                void (this._isRedo = !1);
            this._domNodes.cellEditor._isOpen || this.openCellEditor("enter"),
            io.call(this),
            this.events.dispatch("celleditorinput", {
                value: t.target.value
            })
        }
    }
    function so() {
        this._domNodes.display._hasScrolled = !0,
        this._domNodes.searchCursor.style.transition = ""
    }
    function no(t, e) {
    ...
    var ao = function(t, e) {
        no(this._viewportPosition, t) || (this._viewportPosition = t,
        this._viewportOverflowPx = e,
        Ot.call(this),
        Dt.call(this),
      ...
      , co = function(t) {
        return t.x < this._panesXids.left.length && (t.x = this._panesXids.left.length),
        t.y < this._panesYids.top.length && (t.y = this._panesYids.top.length),
        t.x > this._lastColView.startIndex && (t.x = this._lastColView.startIndex),
        t.y > this._lastRowView.startIndex && (t.y = this._lastRowView.startIndex),
        t
    };
    function uo(t) {
        this._domNodes.display._hasScrolled || so.call(this),
        this._scrollLeft = Math.round(t.currentTarget.scrollLeft),
        this._scrollTop = Math.round(t.currentTarget.scrollTop),
        this._domNodes.display._setViewportPositionOnScroll && (ho.call(this, {
            x: this._panesXids.left.length + Math.floor(this._scrollLeft / 40),
            y: this._panesYids.top.length + Math.floor(this._scrollTop / 40)
        }),
        this.redraw()),
        this._currentDragAction && this._domNodes.display[this._currentDragAction + "MoveFunc"].call(this),
        this._domNodes.display._setViewportPositionOnScroll = !0
    }
    function po() {
        this._domNodes.display._hasScrolled = !1,
        this._domNodes.searchCursor.style.transition = "transform 0.05s"
    }
    function fo(t) {
        po.call(this)
    }
    ...
    function mo(t, e) {
        void 0 === e && (e = !1);
        var i, o, s, n = null;
        if (t < this._cd.rowHeaderSpace)
            return -1;
        t <= this._cd.panesX.left.space ? (i = this._cd.rowHeaderSpace,
        o = "left",
        s = this._panesXids.left) : (i = this._cd.panesX.center.offset,
        o = "center",
        s = this._colView);
        for (var r = i, l = 0; r < t && !(l > s.length - 1); )
            r += this.getColWidthById(s[l]),
            l++;
        (n = l - 1,
        "center" == o && (n += this._viewportPosition.x),
        e) && (n < 0 && (n = 0),
        t - this.getColPositionInViewport(n) > this.getColWidthById(this.getColIdByCoord(n)) / 2 && n++);
        return n
    }
    function xo(t, e) {
        void 0 === e && (e = !1);
        var i, o, s, n = null;
        if (t < this._cd.colHeaderSpace)
            return -1;
        t <= this._cd.panesY.top.space ? (i = this._cd.colHeaderSpace,
        o = "top",
        s = this._panesYids.top) : (i = this._cd.panesY.center.offset,
        o = "center",
        s = this._rowView);
        for (var r = i, l = 0; r < t && !(l > s.length - 1); )
            r += this.getRowHeightById(s[l]),
            l++;
        (n = l - 1,
        "center" == o && (n += this._viewportPosition.y),
        e) && (n < 0 && (n = 0),
        t - this.getRowPositionInViewport(n) > this.getRowHeightById(this.getRowIdByCoord(n)) / 2 && n++);
        return n
    }
    function wo(t) {
        return {
    ...
    function bo(t) {
        if (!this._sectionsPerPaneX.left.length) {
            if (t.y < 0 || t.y > this._cd.colHeaderSpace)
                return null;
    ...
    function So(t) {
        if (!this._sectionsPerPaneY.top.length) {
            if (t.x < 0 || t.x > this._cd.rowHeaderSpace)
                return null;
    ...
    function Ro(t) {
        if (t.y > this._cd.colHeaderSpace || this._colViewOverflow < 0 && t.x > this._cd.viewportWidth - Math.abs(this._colViewOverflow))
            return null;
    ...
    function Po(t) {
        ...
        for (var e = wo.call(this, t), i = null, o = this._cd.rowHeaderSpace, s = 0; s < this._panesXids.left.length; s++)
            if (o += this.getColWidthById(this._panesXids.left[s]),
            t.x <= o) {
                t.x >= o - 4 && (e.x = s,
                i = {
                    name: "colHeaderEdge",
        ...
        for (s = 0; s < this._colView.length; s++)
            if (o += this.getColWidthById(this._colView[s]),
            t.x <= o) {
                t.x >= o - 4 && (e.x = this._viewportPosition.x + s,
                i = {
                    name: "colHeaderEdge",
                    coords: e,
                    objectPosition: {
    ...
    function ko(t) {
        ...
        return t.endsWith("touch") && e.slice(0, -5),
        this[e] || !0
    }
    function Ho(t) {
        if (!ko.call(this, "freezeCols") || this._freezeLineColAfterId && !this._sectionsPerPaneX.left.length)
            return null;
    ...
    function zo(t) {
        ...
        if (t.y < e || t.y > this.colHeaderHeight - e)
            return null;
        var i = null
          , o = wo.call(this, t)
          , s = this.getColPositionInViewport(o.x)
          , n = this.getColIdByCoord(o.x);
        if (o.x >= this._cols.iconList.length)
            return null;
        if (null !== this._cols.iconList[o.x][0] && t.x >= s && t.x <= s + 14) {
            ...
            var a = o.x + 1
              , c = (this.getColIdByCoord(a),
            a > this._cols.coordList.length - 1 ? null : {
    ...
    function Ao(t) {
        ...
        if (i.y >= this._rows.iconList.length)
            return null;
        if (null !== this._rows.iconList[i.y][0] && t.y >= o && t.y <= o + 16) {
            ...
            var h = i.y + 1
              , a = (this.getRowIdByCoord(h),
            h > this._rows.coordList.length - 1 ? null : {
                x: 0,
    ...
    function To(t) {
        if (t.x > this._cd.rowHeaderSpace || this._rowViewOverflow < 0 && t.y > this._cd.viewportHeight - Math.abs(this._rowViewOverflow))
            return null;
        var e = wo.call(this, t)
    ...
    function Eo(t) {
        if (!ko.call(this, "freezeRows") || this._freezeLineRowAfterId && !this._sectionsPerPaneY.top.length)
            return null;
    ...
    function Bo(t) {
        if (null == this._selection || 0 == this._selection.length)
            return null;
        var e = null
    ...
    function Uo(t) {
        if (t < this._rows.coordList.length)
            var e = this.getRowPositionInViewport(t);
        else {
    ...
    var Zo = {
        ...
        move: function(t) {
            var e, i = this, o = t.pointerPositionPx.y - t.pointerOffset, s = xt.call(this, t.range);
            o < this._cd.colHeaderSpace && (o = this._cd.colHeaderSpace),
            o > this._cd.viewportHeight - s && (o = this._cd.viewportHeight),
            (e = Io(t.pointerPosition.y, t.range) ? t.range[0] : t.pointerPosition.y < t.range[0] ? t.pointerPosition.y : t.pointerPosition.y + 1) < 0 && (e = 0),
            t.endCoord = e || 0,
            requestAnimationFrame((function() {
                Wo.call(i, o),
                Uo.call(i, e)
    ...
    function es(t) {
        if (t < this._rows.coordList.length)
            var e = this.getRowPositionInViewport(t);
        0 != t && t != this._panesYids.top.length || (e -= 6),
        this._domNodes.guideForFreezeRows.style.transform = "translateY(" + e + "px)"
    }
    function is(t) {
    ...
    var ss, ns = (ss = function(t) {
        t.ghostPositionPx = t.pointerPositionPx.y - t.pointerOffset - 1,
        t.endCoord = $o(xo.call(this, t.pointerPositionPx.y, !0), 0, this._rows.coordList.length - 1)
    }
    ,
    {
        start: function(t) {
        ...
        move: function(t) {
            ...
            ss.call(this, t),
            requestAnimationFrame((function() {
                Qo.call(e, t.ghostPositionPx),
                es.call(e, t.endCoord)
            }
            ))
        },
        end: function(t) {
        ...
        prepare: function(t) {
            ...
            i -= this.getRowPositionInViewport(t.coords.y),
            (this._panesYids.top.length || null == this._freezeLineRowAfterId) && (i += 6),
            t.pointerOffset = i,
            ss.call(this, t),
            requestAnimationFrame((function() {
                Jo.call(e, t.ghostPositionPx),
                is.call(e, t.coords.y)
            }
            ))
        },
        release: function(t) {
    ...
    function as(t) {
        if (t < this._cols.coordList.length)
            var e = this.getColPositionInViewport(t);
        0 != t && t != this._panesXids.left.length || (e -= 6),
        this._domNodes.guideForFreezeCols.style.transform = "translateX(" + e + "px)"
    }
    function cs(t) {
    ...
    var us = function() {
        var t = function(t) {
            t.ghostPositionPx = t.pointerPositionPx.x - t.pointerOffset - 1,
            t.endCoord = $o(mo.call(this, t.pointerPositionPx.x, !0), 0, this._cols.coordList.length - 1)
        };
        return {
            start: function(t) {
            ...
            move: function(e) {
                ...
                t.call(this, e),
                requestAnimationFrame((function() {
                    rs.call(i, e.pointerPositionPx.x),
                    as.call(i, e.endCoord)
                }
                ))
            },
            end: function(t) {
            ...
            prepare: function(e) {
                ...
                o -= this.getColPositionInViewport(e.coords.x),
                (this._panesXids.left.length || null == this._freezeLineColAfterId) && (o += 6),
                e.pointerOffset = o,
                t.call(this, e),
                requestAnimationFrame((function() {
                    ls.call(i, e.ghostPositionPx),
                    cs.call(i, e.coords.x)
                }
                ))
            },
            release: function(t) {
    ...
    function gs(t) {
        this._domNodes.guideForResizeCols.style.opacity = this._domNodes.guideForResizeCols._opacity,
        fs.call(this, t)
    }
    function _s() {
    ...
    var vs = function() {
        var t = function(t) {
            ...
            e < o ? e = o : e + 4 > i && (e = i - 3),
            e < this._cd.rowHeaderSpace && (e = this._cd.rowHeaderSpace),
            t.guidePositionPx = e,
            t.size = e - this.getColPositionInViewport(t.coords.x)
        };
        return {
            start: function(t) {},
            move: function(e) {
            ...
            prepare: function(e) {
                var i = this
                  , o = e.pointerPositionPx.x;
                o -= this.getColPositionInViewport(e.coords.x),
                o -= this.getColWidthById(this._cols.coordList[e.coords.x]) - 4,
                e.pointerOffset = o,
                t.call(this, e),
                requestAnimationFrame((function() {
    ...
    function Is(t, e, i) {
        ...
        if ("document" == e)
            ...
            if (null == i)
                var n = this._selection[this._activeRangeIndex].range;
            else
                n = this._selection[i].range;
            if (null != n)
                s = Ls.call(this, n);
            else
                s = Rs.call(this, n)
    ...
    function Ps(t) {
        ...
        if (e(t)) {
            ...
            return t[0].x < t[1].x ? (n.x = t[0].x,
            r.x = t[1].x) : (n.x = t[1].x,
            r.x = t[0].x),
            t[0].y < t[1].y ? (n.y = t[0].y,
            r.y = t[1].y) : (n.y = t[1].y,
            r.y = t[0].y),
            [n, r]
        }
    ...
    var Ns = {
        ...
        move: function(t) {
            ...
            t.dragDirection = e.dragDirection,
            t.dragAmount = e.dragAmount,
            Ki.call(this, "fill", e.targetCellRange, t)
        },
        end: function(t) {
      ...
      , Hs = {
        ...
        moveCols: {
            handler: {
                ...
                move: function(t) {
                    var e, i = this, o = t.pointerPositionPx.x - t.pointerOffset, s = vt.call(this, t.range);
                    o < this._cd.rowHeaderSpace && (o = this._cd.rowHeaderSpace),
                    o > this._cd.viewportWidth - s && (o = this._cd.viewportWidth - s),
                    (e = Io(t.pointerPosition.x, t.range) ? t.range[0] : t.pointerPosition.x < t.range[0] ? t.pointerPosition.x : t.pointerPosition.x + 1) < 0 && (e = 0),
                    t.endCoord = e || 0,
                    requestAnimationFrame((function() {
                        ms.call(i, o),
                        Cs.call(i, e)
        ...
        selectCells: {
            handler: {
                ...
                move: function(t) {
                    var e = !0;
                    "e"in t && t.e[this._commandKey] && (e = !1),
                    this.setCellRangeExtreme(t.pointerPosition, e)
                },
                end: function(t) {},
                prepare: function(t) {},
                release: function(t) {}
        ...
        selectRows: {
            handler: {
                ...
                move: function(t) {
                    var e = !0;
                    "e"in t && t.e[this._commandKey] && (e = !1),
                    this.setRowRangeExtreme(t.pointerPosition.y, e)
                },
                end: function(t) {},
                prepare: function(t) {},
                release: function(t) {}
        ...
        selectCols: {
            handler: {
                ...
                move: function(t) {
                    var e = !0;
                    "e"in t && t.e[this._commandKey] && (e = !1),
                    this.setColRangeExtreme(t.pointerPosition.x, e)
                },
                end: function(t) {},
                prepare: function(t) {},
                release: function(t) {}
    ...
    function Ms() {
        for (var t = ["next", "prev"], e = 0; e < t.length; e++)
            P(this._domNodes["hintForShowCols" + No(t[e])], {
                opacity: 0
            })
    }
    function Bs() {
        for (var t = ["next", "prev"], e = 0; e < t.length; e++)
            P(this._domNodes["hintForShowRows" + No(t[e])], {
                opacity: 0
            })
    }
    function Os() {
    ...
    function Ds(t) {
        if (void 0 === t && (t = null),
        null == t)
            return this._domNodes.eventArea.style.cursor = "",
            void (this._domNodes.eventArea._mouseCursorState = null);
        var e = this.mouseCursorStatesDrag[t];
        e && (this._domNodes.eventArea.style.cursor = e)
    }
    function Vs(t, e, i, o) {
        if (-1 == o.indexOf("center"))
            return 0;
        var s = 0
          , n = this._cd.panesX.left.space
          , r = n + this._cd.panesX.center.space;
        return t > r ? s = t - r : t < n && (s = t - n),
        s
    }
    function Xs(t, e, i, o) {
        if (-1 == o.indexOf("center"))
    ...
    function Ys(t) {
        ...
        this._edgeOffsetX < -40 ? e = -40 : this._edgeOffsetX > 40 && (e = 40),
        this._edgeOffsetY < -40 ? i = -40 : this._edgeOffsetY > 40 && (i = 40),
        0 != this._edgeOffsetX && "y" != t && (this._domNodes.scrollArea.scrollLeft += e),
        0 != this._edgeOffsetY && "x" != t && (this._domNodes.scrollArea.scrollTop += i),
        this._domNodes.display._edgeDetectTimeout = setTimeout(this._domNodes.display._edgeDetectFunction, 50)
    }
    function Ws(t) {
        void 0 === t && (t = "xy"),
        this._edgeOffsetX = 0,
        this._edgeOffsetY = 0,
        t && (this._domNodes.display._edgeDetectFunction = Ys.bind(this, t),
        this._domNodes.display._edgeDetectTimeout = setTimeout(this._domNodes.display._edgeDetectFunction, 50))
    }
    function Ks(t) {
        if (void 0 === t && (t = null),
    ...
    function $s(t) {
        ...
        Ms.call(this),
        Bs.call(this),
        null == e ? Ks.call(this, "default") : ("hiddenRowGroupIcon" == e.name ? Zs.call(this, e) : "hiddenColGroupIcon" == e.name && Gs.call(this, e),
        "colHeaderEdge" == e.name ? js.call(this, e.objectPosition.x) : e.name.startsWith("freezeLineCol") ? Us.call(this, e.objectPosition.x) : e.name.startsWith("freezeLineRow") && qs.call(this, e.objectPosition.y),
        Ks.call(this, e.name))
    }
    function Qs() {
        null != this._domNodes.display._edgeDetectTimeout && (clearTimeout(this._domNodes.display._edgeDetectTimeout),
        this._domNodes.display._edgeDetectTimeout = null),
        this._edgeOffsetX = 0,
        this._edgeOffsetY = 0
    }
    function Js(t) {
        Qs.call(this),
        document.removeEventListener("mousemove", this._domNodes.display[t + "MoveFunc"]),
        document.removeEventListener("mouseup", this._domNodes.display[t + "EndFunc"]),
        this._currentDragAction = null,
        $s.call(this, this._domNodes.display[t + "Properties"].pointerPositionPx),
        mi.call(this, "eventArea", "mousemove"),
        mi.call(this, "eventArea", "mouseleave"),
        this.redraw()
    }
    function tn(t, e) {
        void 0 === e && (e = {
    ...
    var en = function(t, e) {
      ...
      , on = function(t, e) {
        ...
        this._domNodes.scrollArea.scrollLeft = i,
        this._domNodes.scrollArea.scrollTop = o
    }
      , sn = function(t) {
        return t.x < this._panesXids.left.length && (t.x = this._panesXids.left.length),
        t.y < this._panesYids.top.length && (t.y = this._panesYids.top.length),
    ...
    function nn(t, e, i) {
        t in Hs && ("allow" + No(t)in this && !this["allow" + No(t)] || (i.panesY = [i.paneY],
        i.panesX = [i.paneX],
        zs.call(this),
        As.call(this),
        this._domNodes.display[t + "Properties"] = go(i),
        this._domNodes.display[t + "Flags"] = {
            hasMoved: !1
        },
        t + "MoveFunc"in this._domNodes.display || rn.call(this, t, e, i),
        t + "EndFunc"in this._domNodes.display || ln.call(this, t, e, i),
        xi.call(this, "eventArea", "mousemove"),
        xi.call(this, "eventArea", "mouseleave"),
        Os.call(this),
        Ds.call(this, t),
        this._currentDragAction = t,
        Hs[t].handler.prepare.call(this, this._domNodes.display[t + "Properties"]),
        document.addEventListener("mousemove", this._domNodes.display[t + "MoveFunc"]),
        document.addEventListener("mouseup", this._domNodes.display[t + "EndFunc"])))
    }
    var rn = function(t, e, i) {
        this._domNodes.display[t + "MoveFunc"] = function(e) {
            ...
            if (null != e && (i.e = e),
            o.hasMoved || (Ws.call(this, Hs[t].edgeDetection),
            Hs[t].handler.start.call(this, i),
            o.hasMoved = !0),
            null == e)
                var s = i.pointerPositionPx;
            else
                s = _o.call(this, e.clientX, e.clientY);
            ...
            var n = i.paneY
              ...
              , u = null
              , p = null;
            "top" == i.paneY && "center" == a && !this._isViewportConnectedTo.top && Hs[t].edgeDetection.includes("y") && 1 == i.panesY.length && (u = this._panesYids.top.length),
            "left" == i.paneX && "center" == h && !this._isViewportConnectedTo.left && Hs[t].edgeDetection.includes("x") && 1 == i.panesX.length && (p = this._panesXids.left.length),
            i.panesY.indexOf("center") > -1 && "top" == a && !this._isViewportConnectedTo.top && (l.y = this._viewportPosition.y),
            i.panesX.indexOf("center") > -1 && "left" == h && !this._isViewportConnectedTo.left && (l.x = this._viewportPosition.x),
            null === p && null === u || tn.call(this, {
                x: null !== p ? p : this._viewportPosition.x,
                y: null !== u ? u : this._viewportPosition.y
            }),
            null !== u && (i.pointerPosition.y = xo.call(this, s.y)),
            null !== p && (i.pointerPosition.x = mo.call(this, s.x)),
            i.pointerPositionPx = s,
            i.pointerPosition = l,
            i.newPaneX = h,
            i.newPaneY = a,
            this._isViewportConnectedTo.top && "top" == a ? i.panesY = ["top"] : a != i.panesY[i.panesY.length - 1] && i.panesY.push(a),
            this._isViewportConnectedTo.left && "left" == h ? i.panesX = ["left"] : h != i.panesX[i.panesX.length - 1] && i.panesX.push(h),
            i.newColSection = c,
            i.newRowSection = d,
            Hs[t].handler.move.call(this, i),
            this._edgeOffsetX = Vs.call(this, s.x, r, h, i.panesX),
            this._edgeOffsetY = Xs.call(this, s.y, n, a, i.panesY)
        }
        .bind(this)
    }
      , ln = function(t, e, i) {
        this._domNodes.display[t + "EndFunc"] = function(e) {
            Js.call(this, t),
            Hs[t].handler.release.call(this, this._domNodes.display[t + "Properties"]),
            this._domNodes.display[t + "Flags"].hasMoved && Hs[t].handler.end.call(this, this._domNodes.display[t + "Properties"]),
            delete this._domNodes.display[t + "Properties"]
        }
        .bind(this)
    };
    function hn(t, e) {
    ...
    function cn(t, e) {
        3 == t.which && this.getRowRangesFromCoord(e.coords.y).length || ("mouse" == e.pointer ? (t.shiftKey ? this.setRowRangeExtreme(e.coords.y, !0) : t[this._commandKey] ? this.addRowRangeToSelection([e.coords.y, e.coords.y]) : this.setRowSelection(e.coords.y, !0, !1),
        nn.call(this, "selectRows", t, e)) : "touch" == e.pointer && this.setRowSelection(e.coords.y, !0, !1))
    }
    function dn(t, e) {
    ...
    function fn(t, e) {
        3 == t.which && this.getColRangesFromCoord(e.coords.x).length || ("mouse" == e.pointer ? (t.shiftKey ? this.setColRangeExtreme(e.coords.x, !0) : t[this._commandKey] ? this.addColRangeToSelection([e.coords.x, e.coords.x]) : this.setColSelection(e.coords.x, !0, !1),
        nn.call(this, "selectCols", t, e)) : "touch" == e.pointer && this.setColSelection(e.coords.x, !0, !1))
    }
    function gn(t, e) {
        3 != t.which && nn.call(this, "freezeCols", t, e)
    }
    ...
    function yn(t, e) {
        3 == t.which && this.getAnyRangesFromCellCoords(e.coords).length || ("mouse" == e.pointer ? (t.shiftKey ? this.setCellRangeExtreme(e.coords, !0) : t[this._commandKey] ? this.addCellRangeToSelection([e.coords, e.coords]) : this.setCellSelection(e.coords),
        nn.call(this, "selectCells", t, e)) : this.setCellSelection(e.coords))
    }
    function vn(t, e) {
    ...
    function mn(t) {
        var e = _o.call(this, t.clientX, t.clientY)
          , i = Oo.call(this, e);
        this._domNodes.display._initialMouseHitArea = go(i),
        null != i && (i.pointer = "mouse",
        "jointHeader" == i.name ? Xo.call(this, t, i) : "fillHandle" == i.name ? vn.call(this, t, i) : "freezeLinePlaceholderCol" == i.name ? gn.call(this, t, i) : "freezeLinePlaceholderRow" == i.name ? _n.call(this, t, i) : "freezeLineRow" == i.name ? hn.call(this, t, i) : "hiddenRowGroupIcon" == i.name ? Vo.call(this, t, i) : "selectedRowHeader" == i.name ? an.call(this, t, i) : "rowHeader" == i.name ? cn.call(this, t, i) : "freezeLineCol" == i.name ? dn.call(this, t, i) : "hiddenColGroupIcon" == i.name ? Do.call(this, t, i) : "colHeaderEdge" == i.name ? un.call(this, t, i) : "selectedColHeader" == i.name ? pn.call(this, t, i) : "colHeader" == i.name ? fn.call(this, t, i) : "cell" == i.name && yn.call(this, t, i))
    }
    function xn(t) {
    ...
    function wn(t) {
        ...
        this._pointerPosition = wo.call(this, this._pointerPositionPx),
    ...
    function bn(t) {
        if (!(t.ctrlKey || t.metaKey || t.shiftKey)) {
            ...
            if (e) {
                ...
                null != i && (this.allowResizeCols && "colHeaderEdge" == i.name && "colHeaderEdge" == e.name && no(i.coords.x, e.coords.x) ? ys(i.coords.x, this.getColSelection()) ? this.resizeColsToFit(this.getColSelection()) : this.resizeColsToFit(i.coords.x) : this.allowEditCells && "cell" == i.name && "cell" == e.name && no(i.coords, e.coords) && this.openCellEditor("edit"),
                this._domNodes.display._initialMouseHitArea = void 0)
            }
        }
    }
    function Sn(t) {
        for (var e = [], i = 0; i < t.length; i++)
            "string" == typeof t[i] ? !(t[i]in this._presetContextMenuItems) || "include"in this._presetContextMenuItems[t[i]] && !this._presetContextMenuItems[t[i]].include.call(this) || e.push(this._presetContextMenuItems[t[i]]) : e.push(t[i]);
        return e
    }
    function In(t, e) {
        (void 0 === t && (t = {}),
        t.contextMenu = this.constructor.contextMenu,
        t.items = Sn.call(this, this.contextMenuItems),
        t.items.length) && (this.events.dispatch("beforeopencontextmenu", t) && (this.constructor.contextMenu.open(this, t.items, t.snapPointX, t.snapPointY, this._handlers.contextMenu.selectItem, this._handlers.contextMenu.close),
        to.call(this, "contextMenuOpen"),
        this.events.dispatch("opencontextmenu", t)))
    }
    function Rn(t) {
        3 == t.which && (this._pointerPositionPx = _o.call(this, t.clientX, t.clientY),
        null == yo.call(this, this._pointerPositionPx) && null == vo.call(this, this._pointerPositionPx) && In.call(this, {
    ...
    function Hn(t, e) {
        void 0 === t && (t = {}),
        t.contextMenu.execClose(),
        this._isActive && kn.call(this),
        this.events.dispatch("closecontextmenu", t)
    }
    function zn(t) {
        void 0 === t && (t = {}),
        t.contextMenu.close(),
        t.item.method.call(this),
        this.events.dispatch("contextmenuselectitem", t)
    }
    function An() {
        this._handlers = {
            contextMenu: {
    ...
    function Tn() {
        ...
        for (var e in t)
            for (var i = 0; i < t[e].length; i++)
                mi.call(this, e, t[e][i]);
        this._domNodes.container._resizeSensor.events.on("resize", this._listeners.container.resize),
        this._domNodes.lineHeightMeter._resizeSensor.events.on("resize", this._listeners.lineHeightMeter.resize)
    }
    function Fn() {
        En.call(this, "topBar"),
        En.call(this, "bottomBar")
    }
    var En = function(t) {
        if ("topBar" == t)
            var e = this._validatedTopBar
              , i = this._topBarNodes;
        else if ("bottomBar" == t)
            e = this._validatedBottomBar,
            i = this._bottomBarNodes;
    ...
    var Bn = function(t, e) {
        ...
        i._context.msImageSmoothingEnabled = !1,
        i._context.webkitImageSmoothingEnabled = !1,
        i._context.imageSmoothingEnabled = !1
    }
      , On = function(t, e) {
        var i = this._domNodes.canvas[t + "-" + e]
          , o = i._displayWidth / 1
    ...
    function Dn() {
        for (var t, e, i = Array.prototype.slice.call(arguments), o = [0, 0, 0, 0]; e = i.shift(); )
            void 0 === e[3] && (e[3] = 1),
            o[3] && e[3] ? ((t = [0, 0, 0, 0])[3] = 1 - (1 - e[3]) * (1 - o[3]),
            t[0] = Math.round(e[0] * e[3] / t[3] + o[0] * o[3] * (1 - e[3]) / t[3]),
            t[1] = Math.round(e[1] * e[3] / t[3] + o[1] * o[3] * (1 - e[3]) / t[3]),
            t[2] = Math.round(e[2] * e[3] / t[3] + o[2] * o[3] * (1 - e[3]) / t[3])) : t = e || o,
            o = t;
        return t
    }
    function Vn(t) {
    ...
    function Xn() {
        ...
        for (var e in this._domNodes.canvas) {
            ...
            i._context.fillStyle = this.getThemeSetting("sheet"),
            i._context.fillRect(0, 0, i._drawWidth, i._drawHeight);
            for (var o = 0; o < i._drawHeight && !(o > t[i._panePositionY].length - 1); o++)
                Yn.call(this, i, o, t[i._panePositionY][o], i._panePositionX),
                o == t[i._panePositionY].length - 1 && Yn.call(this, i, o + 1, t[i._panePositionY][o], i._panePositionX)
        }
    }
    var Yn = function(t, e, i, o) {
        ...
        for (var s = {
            ...
            t._context.fillStyle = a,
            t._context.fillRect(n, e, h, 1),
            n += h
        }
    };
    function Wn() {
    ...
    var Kn = function() {
        this._domNodes["column-top"].innerHTML = Ge.call(this),
        this._domNodes["column-center"].innerHTML = Ze.call(this)
    }
      , jn = function() {
        for (var t = z(), e = this._cd.rowHeaderSpace, i = 0; i < this._panesXids.left.length; i++) {
            ...
            n["column-top"].textContent = ti.call(this, s.id),
            n["column-center"].textContent = ei.call(this, s.id),
            n.column.style.transform = "translateX(" + e + "px)",
            n.column.style.opacity = 1,
            t.appendChild(n.column),
            e += s.width
        }
    ...
    function qn() {
        for (var t, e, i = 1 == this._selection.length, o = 0; o < this._selection.length; o++)
            t = Di.call(this, this._selection[o].range),
            e = o == this._activeRangeIndex,
            Gn.call(this, this._selection[o].range, o, t, i, e);
        for (; this._domNodes.cellRangeContainer.children.length > this._selection.length; )
            this._domNodes.cellRangeContainer.removeChild(this._domNodes.cellRangeContainer.lastChild),
            this._domNodes.cellRangeForegroundContainer.removeChild(this._domNodes.cellRangeForegroundContainer.lastChild)
    }
    var Gn = function(t, e, i, o, s) {
        e > this._domNodes.cellRangeContainer.children.length - 1 && (this._domNodes.cellRangeContainer.appendChild(te(this._templates.cellRange)),
        this._domNodes.cellRangeForegroundContainer.appendChild(te(this._templates.cellRangeForeground)));
        var n = Vi.call(this, t);
        Zn.call(this, e, n, i, o, s),
        $n.call(this, e, n, i, o, s)
    }
      ...
      , $n = function(t, e, i, o, s) {
        ...
        n.style.transform = l,
        n.style.width = e.x.size + "px",
        n.style.height = e.y.size + "px",
        n.style["border-left-style"] = e.x.lineLeft ? r : "none",
        n.style["border-right-style"] = e.x.lineRight ? r : "none",
        n.style["border-top-style"] = e.y.lineTop ? r : "none",
        n.style["border-bottom-style"] = e.y.lineBottom ? r : "none"
    };
    function Qn(t) {
        return [t, t]
    }
    function Jn(t) {
        var e = !1
          , i = !1;
        return (t.y >= 0 && t.y < this._panesYids.top.length || t.y >= this._viewportPosition.y && t.y < this._viewportPosition.y + this._rowView.length) && (e = !0),
        (t.x >= 0 && t.x < this._panesXids.left.length || t.x >= this._viewportPosition.x && t.x < this._viewportPosition.x + this._colView.length) && (i = !0),
        !(!e || !i)
    }
    function tr() {
        ...
        if (this._selection.length && !this._domNodes.cellEditor._isOpen) {
            ...
            if (null != e) {
                t.style.opacity = t._opacity || "",
                i.y.lineTop && 0 != i.x.size ? t.style["border-top-style"] = o : t.style["border-top-style"] = "none",
                i.y.lineBottom && 0 != i.x.size ? t.style["border-bottom-style"] = o : t.style["border-bottom-style"] = "none",
                i.x.lineLeft && 0 != i.y.size ? t.style["border-left-style"] = o : t.style["border-left-style"] = "none",
                i.x.lineRight && 0 != i.y.size ? t.style["border-right-style"] = o : t.style["border-right-style"] = "none";
                var s = "translate(" + i.x.offset + "px," + i.y.offset + "px)";
                t.style.transform = s,
                t.style.width = i.x.size + "px",
                t.style.height = i.y.size + "px",
                Jn.call(this, this._cellCursorPosition) ? this._domNodes.cellCursor.style.opacity = this._domNodes.cellCursor._opacity : this._domNodes.cellCursor.style.opacity = 0
            } else
                t.style.opacity = 0
        } else
            t.style.opacity = 0
    ...
    function er() {
        ...
        if (this._searchCellsFound.length) {
            ...
            if (null != i) {
                t.style.opacity = t._opacity || "",
                o.y.lineTop && 0 != o.x.size ? t.style["border-top-style"] = s : t.style["border-top-style"] = "none",
                o.y.lineBottom && 0 != o.x.size ? t.style["border-bottom-style"] = s : t.style["border-bottom-style"] = "none",
                o.x.lineLeft && 0 != o.y.size ? t.style["border-left-style"] = s : t.style["border-left-style"] = "none",
                o.x.lineRight && 0 != o.y.size ? t.style["border-right-style"] = s : t.style["border-right-style"] = "none";
                var n = "translate(" + (o.x.offset - 2) + "px," + (o.y.offset - 2) + "px)";
                t.style.transform = n,
                t.style.width = o.x.size + 4 + "px",
                t.style.height = o.y.size + 4 + "px",
                Jn.call(this, i[0]) ? this._domNodes.searchCursor.style.opacity = this._domNodes.searchCursor._opacity : this._domNodes.searchCursor.style.opacity = 0
            } else
                t.style.opacity = 0
        } else
            t.style.opacity = 0
    ...
    function sr() {
        for (var t = We(this._selection, {
            ...
            type: "row"
        }), i = t.length, o = this._selection.length - t.length, s = e.length, n = this._selection.length - e.length, r = 0; r < t.length; r++)
            hr.call(this, t[r].range, r);
        var l = 0;
        for (r = 0; r < this._selection.length; r++)
            "col" != this._selection[r].type && (lr.call(this, this._selection[r].range, l),
            l++);
        for (r = 0; r < e.length; r++)
            rr.call(this, e[r].range, r);
        for (l = 0,
        r = 0; r < this._selection.length; r++)
            "row" != this._selection[r].type && (nr.call(this, this._selection[r].range, l),
            l++);
        for (; this._domNodes.colHeaderRangeHighlightContainer.children.length > o; )
            this._domNodes.colHeaderRangeHighlightContainer.removeChild(this._domNodes.colHeaderRangeHighlightContainer.lastChild);
        for (; this._domNodes.colHeaderRangeSelectedContainer.children.length > i; )
            this._domNodes.colHeaderRangeSelectedContainer.removeChild(this._domNodes.colHeaderRangeSelectedContainer.lastChild);
        for (; this._domNodes.rowHeaderRangeHighlightContainer.children.length > n; )
            this._domNodes.rowHeaderRangeHighlightContainer.removeChild(this._domNodes.rowHeaderRangeHighlightContainer.lastChild);
        for (; this._domNodes.rowHeaderRangeSelectedContainer.children.length > s; )
            this._domNodes.rowHeaderRangeSelectedContainer.removeChild(this._domNodes.rowHeaderRangeSelectedContainer.lastChild)
    }
    var nr = function(t, e) {
    ...
    function cr() {
        pr.call(this, "next", dr.call(this)),
        pr.call(this, "prev", ur.call(this))
    }
    var dr = function() {
        for (var t = [], e = 0; e < this._panesYids.top.length; e++)
            null !== this._rows.iconList[e][1] && t.push({
      ...
      , ur = function() {
        for (var t = [], e = 0; e < this._panesYids.top.length; e++)
            null !== this._rows.iconList[e][0] && t.push({
      ...
      , pr = function(t, e) {
        void 0 === t && (t = "next"),
        void 0 === e && (e = []);
        for (var i = this._rows[t + "Nodes"], o = this._domNodes["hiddenRowGroupIcon" + No(t) + "Container"], s = this._templates["hiddenRowGroupIcon" + No(t)], n = z(), r = [], l = 0; l < i.length; l++)
            r.push(l);
        var h = [];
        for (l = 0; l < e.length; l++) {
            var a = ar(i, "position", e[l].position);
            a > -1 ? (r.splice(r.indexOf(a), 1),
            i[a].node.style.opacity = 1) : h.push(e[l].position)
        }
        for (l = 0; l < h.length; l++)
            if (r.length) {
                var c;
                i[c = r.shift()].node.style.transform = "translateY(" + h[l] + "px)",
                i[c].node.style.opacity = 1,
                i[c].position = h[l]
            } else {
                var d = s.cloneNode(!0);
                d.style.transform = "translateY(" + h[l] + "px)",
                i.push({
                    node: d,
                    position: h[l]
                }),
        ...
        for (l = 0; l < r.length; l++)
            i[r[l]].node.style.opacity = 0
    };
    function fr() {
        yr.call(this, "next", _r.call(this)),
        yr.call(this, "prev", gr.call(this))
    }
    var gr = function() {
        for (var t = [], e = 0; e < this._panesXids.left.length; e++)
            null !== this._cols.iconList[e][0] && t.push({
      ...
      , _r = function() {
        for (var t = [], e = 0; e < this._panesXids.left.length; e++)
            null !== this._cols.iconList[e][1] && t.push({
      ...
      , yr = function(t, e) {
        void 0 === t && (t = "next"),
        void 0 === e && (e = []);
        for (var i = this._cols[t + "Nodes"], o = this._domNodes["hiddenColGroupIcon" + No(t) + "Container"], s = this._templates["hiddenColGroupIcon" + No(t)], n = z(), r = [], l = 0; l < i.length; l++)
            r.push(l);
        var h = [];
        for (l = 0; l < e.length; l++) {
            var a = ar(i, "position", e[l].position);
        ...
        for (l = 0; l < h.length; l++)
            if (r.length) {
                var c;
                i[c = r.shift()].node.style.transform = "translateX(" + h[l] + "px)",
                i[c].node.style.opacity = 1,
                i[c].position = h[l]
            } else {
                var d = s.cloneNode(!0);
                d.style.transform = "translateX(" + h[l] + "px)",
                i.push({
                    node: d,
                    position: h[l]
                }),
    ...
    function vr() {
        ...
        if (this._selection.length && !this._domNodes.cellEditor._isOpen) {
            ...
            t.style.transform = "translate(" + s + "px, " + n + "px)",
            !Jn.call(this, e) || String(this._currentDragAction).startsWith("select") ? t.style.opacity = 0 : t.style.opacity = this._domNodes.fillHandle._opacity
        } else
            t.style.opacity = 0
    }
    function mr() {
    ...
    function xr() {
        if (this._lastColView.startIndex > this._viewportPosition.x)
            this._domNodes.blankSheetRight.style.opacity = 0;
        else {
            var t = this._viewportPosition.x + (this._colView.length - 1)
              , e = this.getColPositionInViewport(t);
            e += this.getColWidthById(this._cols.coordList[t]),
            e += 1;
            var i = (this._cd.viewportWidth - e) / 100;
            this._domNodes.blankSheetRight.style.transform = "scaleX(" + i + ")",
            this._domNodes.blankSheetRight.style.opacity = this._domNodes.blankSheetRight._opacity
        }
        if (this._lastRowView.startIndex > this._viewportPosition.y)
            this._domNodes.blankSheetBottom.style.opacity = 0;
        else {
            var o = this._viewportPosition.y + (this._rowView.length - 1)
              , s = this.getRowPositionInViewport(o);
            s += this._actualRowHeight,
            s += 1;
            var n = (this._cd.viewportHeight - s) / 100;
            this._domNodes.blankSheetBottom.style.transform = "scaleY(" + n + ")",
            this._domNodes.blankSheetBottom.style.opacity = n > 0 ? 1 : 0
        }
    }
    function wr() {
        Cr.call(this),
    ...
    var Cr = function() {
        if (null != this._prevSelection)
            for (var t, e = 0; e < this._prevSelection.selection.length; e++)
                for (var i = 0; i < this._prevSelection.selection[e].colIds.length; i++)
                    t = this._prevSelection.selection[e].colIds[i],
                    this._columnNodes[t - 1].columnHeaderLabel.style.color = this.getThemeSetting("header|text")
    }
      , br = function() {
        for (var t, e = We(this._selection, {
            type: "col"
        }), i = 0; i < e.length; i++)
            for (var o = e[i].range[0].x; o <= e[i].range[1].x; o++)
                t = this.getColIdByCoord(o),
                this._columnNodes[t - 1].columnHeaderLabel.style.color = this.getThemeSetting("header:selected|text")
    };
    function Sr() {
        for (var t = [], e = 0; e < this._colLines.length; e++)
            t.push(e);
        var i = this._cd.rowHeaderSpace
          , o = [];
        for (e = 0; e < this._panesXids.left.length; e++)
            i += this.getColWidthById(this._panesXids.left[e]),
            (s = ar(this._colLines, "position", i)) > -1 ? (t.splice(t.indexOf(s), 1),
            this._colLines[s].node.style.opacity = 1) : o.push(i);
        ...
        for (e = 0; e < o.length; e++)
            if (t.length) {
                var r = t.shift();
                this._colLines[r].node.style.transform = "translateX(" + o[e] + "px)",
                this._colLines[r].node.style.opacity = 1,
                this._colLines[r].offset = o[e]
            } else {
                var l = te(this._templates.colLine);
                l.style.transform = "translateX(" + o[e] + "px)",
                n.appendChild(l),
                this._colLines.push({
                    node: l,
                    offset: o[e]
        ...
        for (e = 0; e < t.length; e++)
            this._colLines[t[e]].node.style.opacity = 0
    }
    function Ir() {
        for (var t = [], e = 0; e < this._rowLines.length; e++)
            t.push(e);
        var i = this._cd.colHeaderSpace
          , o = [];
        for (e = 0; e < this._panesYids.top.length; e++)
            i += this.getRowHeightById(this._panesYids.top[e]),
            (s = ar(this._rowLines, "position", i)) > -1 ? (t.splice(t.indexOf(s), 1),
            this._rowLines[s].node.style.opacity = 1) : o.push(i);
        ...
        for (e = 0; e < o.length; e++)
            if (t.length) {
                var r = t.shift();
                this._rowLines[r].node.style.transform = "translateY(" + o[e] + "px)",
                this._rowLines[r].node.style.opacity = 1,
                this._rowLines[r].offset = o[e]
            } else {
                var l = te(this._templates.rowLine);
                l.style.transform = "translateY(" + o[e] + "px)",
                n.appendChild(l),
                this._rowLines.push({
                    node: l,
                    offset: o[e]
        ...
        for (e = 0; e < t.length; e++)
            this._rowLines[t[e]].node.style.opacity = 0
    }
    function Rr() {
        if (this._freezeLineRowAfterId && !this._sectionsPerPaneY.top.length) {
            ...
            this._domNodes.freezeLinePlaceholder_row.style.transform = "translateY(" + t + "px)",
            this._domNodes.freezeLinePlaceholder_row.style.opacity = t ? 1 : 0
        } else
            this._domNodes.freezeLinePlaceholder_row.style.opacity = 0;
        if (this._freezeLineColAfterId && !this._sectionsPerPaneX.left.length) {
            ...
            this._domNodes.freezeLinePlaceholder_col.style.opacity = 0
    }
    function Lr() {
        Xn.call(this),
        Wn.call(this),
        ...
        mr.call(this),
        xr.call(this),
        Wi.call(this, this._domNodes.copyRange, this._copyRange),
        Wi.call(this, this._domNodes.cutRange, this._cutRange),
        Wi.call(this, this._domNodes.fillRange, this._fillRange),
        Sr.call(this),
        Rr.call(this),
        wr.call(this),
        Ir.call(this),
        this.constructor.contextMenu.redrawLabels()
    }
    function Pr() {
        var t = this;
        Nr.call(this),
        ...
        wi.call(this),
        to.call(this, "traverseSingleCell"),
        this.instantActivate ? this.activate() : this.deactivate(),
        setTimeout((function() {
            t._isReady = !0,
    ...
    var Nr = function() {
        this._domNodes.container._resizeSensor = new Kt(this._domNodes.container,this),
        this._domNodes.lineHeightMeter._resizeSensor = new Kt(this._domNodes.lineHeightMeter,this)
    }
      , kr = function() {
        this._templates = {},
        this._templates.colHeaderRangeHighlight = T.call(this, ri.call(this)),
        this._templates.colHeaderRangeSelected = T.call(this, li.call(this)),
        this._templates.rowHeaderRangeHighlight = T.call(this, hi.call(this)),
        this._templates.rowHeaderRangeSelected = T.call(this, ai.call(this)),
        this._templates.cellRange = T.call(this, fi.call(this)),
        this._templates.cellRangeForeground = T.call(this, gi.call(this)),
        this._templates.hiddenRowGroupIconPrev = T.call(this, ci.call(this)),
        this._templates.hiddenRowGroupIconNext = T.call(this, di.call(this)),
        this._templates.hiddenColGroupIconPrev = T.call(this, ui.call(this)),
        this._templates.hiddenColGroupIconNext = T.call(this, pi.call(this)),
        this._templates.colLine = T.call(this, _i.call(this)),
        this._templates.rowLine = T.call(this, yi.call(this))
    };
    function Hr(t, e) {
        var i = this;
        void 0 === t && (t = null),
        void 0 === e && (e = {}),
        this._container = t,
        this._componentIndex = this.constructor.instances.length,
        b.call(this, e),
        "loading" == document.readyState ? document.addEventListener("DOMContentLoaded", (function() {
            J.call(i)
        }
        )) : J.call(this),
        "complete" == document.readyState ? (Xt.call(this),
        Pr.call(this)) : window.addEventListener("load", (function() {
            Xt.call(i),
            Pr.call(i)
        }
        )),
    ...
    var zr = function(t, e) {
        ...
        this._characterKeys = Ar(),
        this._lookupCharacterKeys = Or(this._characterKeys),
        this._modifierKeys = {
            shift: "shiftKey",
            ctrl: t.constructor._isMacOS ? "metaKey" : "ctrlKey",
            alt: "altKey"
        },
        this._nonInputKeyCodes = [8, 9, 13, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 37, 38, 39, 40, 44, 45, 46, 91, 92, 93, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 144, 145, 182, 183],
        this._modifierKeyCodes = [16, 17, 18, 91, 93],
        this._metaKeyCodes = [91, 93],
        this._context = t,
        this.trackedActionKeys = [],
        this.trackedCharacterKeys = [],
        this.trackedModifierKeys = [],
        this.pressedActionKeys = {},
        this.pressedCharacterKeys = {},
        this.pressedModifierKeys = {},
        this.identifyKeyActionTimeout = null,
        this.keysToPrevent = {},
        this.prevKeyAction = null,
        this.keyActions = [],
        this.keys = {},
        this.keyHoldDelay = 350,
        this.keyHoldInterval = 60,
        this._isSuspended = !1,
        this._keyDownListener = Tr.bind(this),
        this._keyUpListener = Fr.bind(this),
        this._identifyKeyAction = Mr.bind(this),
        this._scope = e,
        this._scope.addEventListener("keydown", this._keyDownListener),
        this._scope.addEventListener("keyup", this._keyUpListener)
    };
    zr.prototype.on = function(t, e, i, o) {
        void 0 === i && (i = !0),
        void 0 === o && (o = null);
        for (var s = !1, n = "", r = [], l = [], h = [], a = (t = t.split("+"),
        []), c = 0; c < t.length; c++) {
            var d = t[c].trim();
            d in this._modifierKeys ? r.push(d) : d in this._actionKeys ? l.push(d) : d in this._characterKeys && h.push(d),
            a.push(d)
        }
        if (Br({
            modifierKeys: r,
        ...
        s) {
            if (void 0 === this.keys[n]) {
                ...
                for (c = 0; c < l.length; c++)
                    this._actionKeys[l[c]]in this.keysToPrevent || (this.keysToPrevent[this._actionKeys[l[c]]] = []),
                    this.keysToPrevent[this._actionKeys[l[c]]].push(n);
                for (c = 0; c < h.length; c++)
                    this._characterKeys[h[c]]in this.keysToPrevent || (this.keysToPrevent[this._characterKeys[h[c]]] = []),
                    this.keysToPrevent[this._characterKeys[h[c]]].push(n)
            }
            for (c = 0; c < this.keys[n].actions.length; c++)
                if (this.keys[n].actions[c].callback == e && this.keys[n].actions[c].repeatable == i && this.keys[n].actions[c].target == o)
                    return;
            ...
            for (c = 0; c < a.length; c++)
                a[c]in this._modifierKeys ? -1 == this.trackedModifierKeys.indexOf(this._modifierKeys[a[c]]) && this.trackedModifierKeys.push(this._modifierKeys[a[c]]) : a[c]in this._actionKeys ? (u = this._actionKeys[a[c]],
                -1 == this.trackedActionKeys.indexOf(u) && this.trackedActionKeys.push(u)) : a[c]in this._characterKeys && (u = this._characterKeys[a[c]],
                -1 == this.trackedCharacterKeys.indexOf(u) && this.trackedCharacterKeys.push(u))
        }
    }
    ,
    zr.prototype.off = function(t, e, i, o) {
        for (var s = [], n = [], r = [], l = (t = t.split("+"),
        []), h = 0; h < t.length; h++) {
            var a = t[h].trim();
            a in this._modifierKeys ? r.push(a) : a in this._actionKeys ? s.push(a) : a in this._characterKeys && n.push(a),
            l.push(a)
        }
        if (Br({
            modifierKeys: r,
            ...
            if (void 0 !== this.keys[c]) {
                var d = [];
                for (h = 0; h < this.keys[c].actions.length; h++)
                    this.keys[c].actions[h].callback == e && this.keys[c].actions[h].repeatable == i && this.keys[c].actions[h].target == o || d.push(this.keys[c].actions[h]);
                if (this.keys[c].actions = d,
                    ...
                    for (h = 0; h < this.keyActions.length; h++)
                        if (this.keyActions[h].keyString == c) {
                            for (var u = 0; u < this.keyActions[h].actionKeys.length; u++) {
                                if (this._actionKeys[this.keyActions[h].actionKeys[u]]in this.keysToPrevent)
                                    (p = this.keysToPrevent[this._actionKeys[this.keyActions[h].actionKeys[u]]].indexOf(c)) > -1 && this.keysToPrevent[this._actionKeys[this.keyActions[h].actionKeys[u]]].splice(p, 1),
                                    this.keysToPrevent[this._actionKeys[this.keyActions[h].actionKeys[u]]].length || delete this.keysToPrevent[this._actionKeys[this.keyActions[h].actionKeys[u]]]
                            }
                            for (u = 0; u < this.keyActions[h].characterKeys.length; u++) {
                                var p;
                                if (this._characterKeys[this.keyActions[h].characterKeys[u]]in this.keysToPrevent)
                                    (p = this.keysToPrevent[this._characterKeys[this.keyActions[h].characterKeys[u]]].indexOf(c)) > -1 && this.keysToPrevent[this._characterKeys[this.keyActions[h].characterKeys[u]]].splice(p, 1),
                                    this.keysToPrevent[this._characterKeys[this.keyActions[h].characterKeys[u]]].length || delete this.keysToPrevent[this._characterKeys[this.keyActions[h].characterKeys[u]]]
                            }
    ...
    zr.prototype.suspend = function() {
        this._scope.removeEventListener("keydown", this._keyDownListener),
        this._scope.removeEventListener("keyup", this._keyUpListener)
    }
    ,
    ...
    var Ar = function() {
        for (var t = {}, e = [{
            ...
            for (var o = 0; o < e[i].series.length; o++)
                t[e[i].series[o]] = e[i].startIndex + o;
        return t["\\"] = 220,
        t
    }
      , Tr = function(t) {
        ...
        if (!(this._modifierKeyCodes.indexOf(e) > -1 && null === this.identifyKeyActionTimeout)) {
            ...
            this.trackedActionKeys.indexOf(e) > -1 && !this.pressedActionKeys[e] && (this.pressedActionKeys[e] = !0),
            this.trackedCharacterKeys.indexOf(e) > -1 && !this.pressedCharacterKeys[e] && (this.pressedCharacterKeys[e] = !0),
            null === this.identifyKeyActionTimeout && Mr.call(this, t)
        }
    }
      , Fr = function(t) {
        var e = t.which || t.keyCode;
        this.pressedActionKeys[e] && delete this.pressedActionKeys[e],
        this.pressedCharacterKeys[e] && delete this.pressedCharacterKeys[e],
        this._metaKeyCodes.indexOf(e) > -1 && (this.pressedCharacterKeys = {},
        this.pressedActionKeys = {}),
        0 == Object.keys(this.pressedActionKeys).length && 0 == Object.keys(this.pressedCharacterKeys).length && Er.call(this)
    }
      , Er = function() {
      ...
      , Mr = function(t) {
        ...
        document.hasFocus()) {
            for (var i = [], o = 0; o < this.keyActions.length; o++) {
                for (var s = 0, n = 0; n < this.keyActions[o].modifierKeys.length; n++)
                    this.pressedModifierKeys[this._modifierKeys[this.keyActions[o].modifierKeys[n]]] && s++;
                for (n = 0; n < this.keyActions[o].actionKeys.length; n++)
                    this.pressedActionKeys[this._actionKeys[this.keyActions[o].actionKeys[n]]] && s++;
                for (n = 0; n < this.keyActions[o].characterKeys.length; n++)
                    this.pressedCharacterKeys[this._characterKeys[this.keyActions[o].characterKeys[n]]] && s++;
            ...
            i.length ? (i[0] == this.prevKeyAction ? this.keyActionRepeatCounter++ : this.keyActionRepeatCounter = 0,
            this.keys[i[0].keyString].actions.forEach((function(i) {
                null != i.target || Dr.call(e) ? i.target == t.target && document.activeElement == i.target && (0 == i.repeatable && (e.keyActionRepeatCounter = 0),
                1 != i.repeatable && 0 != e.keyActionRepeatCounter || (i.callback.call(e._context, t),
                t.preventDefault())) : (0 == i.repeatable && (e.keyActionRepeatCounter = 0),
                1 != i.repeatable && 0 != e.keyActionRepeatCounter || i.callback.call(e._context, t))
            }
            )),
            this._context.constructor._isMacOS && i[0].modifierKeys.indexOf("ctrl") > -1 && (this.pressedCharacterKeys = {},
            this.pressedActionKeys = {}),
            this.prevKeyAction = i[0]) : (this.keyActionRepeatCounter = 0,
            this.prevKeyAction = null),
            0 == this.keyActionRepeatCounter)
                var r = this.keyHoldDelay;
            else
                r = this.keyHoldInterval;
      ...
      , Br = function(t) {
        var e = !0;
        return (t.modifierKeys.length && !t.actionKeys.length && !t.characterKeys.length || !t.modifierKeys.length && !t.actionKeys.length && t.characterKeys.length || t.actionKeys.length && t.characterKeys.length) && (e = !1),
        e
    }
      , Or = function(t) {
        var e = {};
    ...
    Vr.prototype.add = function(t) {
        return this.isExecuting || (this.commands.splice(this.index + 1, this.commands.length - this.index),
        this.commands.push(t),
        this.limit && this.commands.length > this.limit && Yr(this.commands, 0, -(this.limit + 1)),
    ...
    Vr.prototype.undo = function() {
        ...
        this.index -= 1,
        this._context.events.dispatch("undo", {
            command: t
        }),
        this.callback && this.callback(),
        this) : this
    ...
    Vr.prototype.redo = function() {
        ...
        this.index += 1,
        this._context.events.dispatch("redo", {
            command: t
        }),
        this.callback && this.callback(),
        this) : this
    ...
    Vr.prototype.clear = function() {
        ...
        this.commands = [],
        this.index = -1,
        this.callback && t > 0 && this.callback()
    }
    ,
    ...
    ;
    var Xr = function(t, e) {
        return t && "function" == typeof t[e] ? (this.isExecuting = !0,
        t[e].call(this._context),
        this.isExecuting = !1,
        this) : this
    }
      , Yr = function(t, e, i) {
        return t.splice(e, !i || 1 + i - e + (!(i < 0 ^ e >= 0) && (i < 0 || -1) * t.length)),
        t.length
    }
      , Wr = function() {
        var t = window;
        var e = !t.document && !!t.postMessage
          ...
          , n = {
            parse: function(e, i) {
                ...
                w(r) && (i.dynamicTypingFunction = r,
                r = {});
                if (i.dynamicTyping = r,
                ...
                var p = null;
                if (e === n.NODE_STREAM_INPUT && "undefined" == typeof PAPA_BROWSER_CONTEXT)
                    return (p = new u(i)).getStream();
            ...
            unparse: function(t, e) {
                ...
                if (Array.isArray(t)) {
                    ...
                    if ("object" == typeof t[0])
                        return p(c || Object.keys(t[0]), t, a)
                } else if ("object" == typeof t)
                    return "string" == typeof t.data && (t.data = JSON.parse(t.data)),
                    Array.isArray(t.data) && (t.fields || (t.fields = t.meta && t.meta.fields),
                    t.fields || (t.fields = Array.isArray(t.data[0]) ? t.fields : "object" == typeof t.data[0] ? Object.keys(t.data[0]) : []),
                    Array.isArray(t.data[0]) || "object" == typeof t.data[0] || (t.data = [t.data])),
                    p(t.fields || [], t.data || [], a);
                ...
                function p(t, e, i) {
                    ...
                    for (var c = 0; c < e.length; c++) {
                        ...
                        if (i && !l && (u = "greedy" === i ? "" === e[c].join("").trim() : 1 === e[c].length && 0 === e[c][0].length),
                        "greedy" === i && l) {
                            for (var f = [], _ = 0; _ < d; _++) {
                                var y = h ? t[_] : _;
                                f.push(e[c][y])
                ...
                function g(t, e) {
                    ...
                    var o = !1;
                    d && "string" == typeof t && d.test(t) && (t = "'" + t,
                    o = !0);
        ...
        if (n.RECORD_SEP = String.fromCharCode(30),
        n.UNIT_SEP = String.fromCharCode(31),
        n.BYTE_ORDER_MARK = "\ufeff",
        n.BAD_DELIMITERS = ["\r", "\n", '"', n.BYTE_ORDER_MARK],
        n.WORKERS_SUPPORTED = !e && !!t.Worker,
        ...
        n.FileStreamer = a,
        n.StringStreamer = c,
        n.ReadableStreamStreamer = d,
        "undefined" == typeof PAPA_BROWSER_CONTEXT && (n.DuplexStreamStreamer = u),
        t.jQuery) {
            var r = t.jQuery;
        ...
        function l(e) {
            ...
            this.parseChunk = function(e, o) {
                ...
                if (!this._handle.paused() && !this._handle.aborted()) {
                    var h = l.meta.cursor;
                    this._finished || (this._partialLine = r.substring(h - this._baseIndex),
                    this._baseIndex = h),
                    ...
                    this._completed || !a || !w(this._config.complete) || l && l.meta.aborted || (this._config.complete(this._completeResults, this._input),
                    this._completed = !0),
                    a || l && l.meta.paused || this._nextChunk(),
                    l
                }
                this._halted = !0
            }
        ...
        function h(t) {
            var i;
            (t = t || {}).chunkSize || (t.chunkSize = n.RemoteChunkSize),
            l.call(this, t),
            this._nextChunk = e ? function() {
                this._readChunk(),
                this._chunkLoaded()
            }
            : function() {
            ...
            this._readChunk = function() {
                if (this._finished)
                    ...
                    e || (i.onload = x(this._chunkLoaded, this),
                    i.onerror = x(this._chunkError, this)),
                    i.open(this._config.downloadRequestBody ? "POST" : "GET", this._input, !e),
            ...
            this._chunkLoaded = function() {
                4 === i.readyState && (i.status < 200 || i.status >= 400 ? this._chunkError() : (this._start += this._config.chunkSize ? this._config.chunkSize : i.responseText.length,
                this._finished = !this._config.chunkSize || this._start >= function(t) {
        ...
        function a(t) {
            var e, i;
            (t = t || {}).chunkSize || (t.chunkSize = n.LocalChunkSize),
            l.call(this, t);
            var o = "undefined" != typeof FileReader;
            this.stream = function(t) {
                this._input = t,
                i = t.slice || t.webkitSlice || t.mozSlice,
                o ? ((e = new FileReader).onload = x(this._chunkLoaded, this),
                e.onerror = x(this._chunkError, this)) : e = new FileReaderSync,
                this._nextChunk()
            }
            ,
        ...
        function d(t) {
            ...
            this._streamData = x((function(t) {
                try {
                    e.push("string" == typeof t ? t : t.toString(this._config.encoding)),
                    i && (i = !1,
                    this._checkIsFinished(),
            ...
            this._streamError = x((function(t) {
                this._streamCleanUp(),
                this._sendError(t)
            }
            ), this),
        ...
        function u(t) {
            ...
            ,
            i.step = x(this._onCsvData, this),
            i.complete = x(this._onCsvComplete, this),
            l.call(this, i),
            this._nextChunk = function() {
                s && 1 === n.length && (this._finished = !0),
                n.length ? n.shift()() : o = !0
            }
            ,
            this._addToParseQueue = function(t, e) {
                n.push(x((function() {
                    if (this.parseChunk("string" == typeof t ? t : t.toString(i.encoding)),
                    w(e))
                        return e()
                }
                ), this)),
        ...
        function p(t) {
            var e, i, o, s = Math.pow(2, 53), r = -s, l = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/, h = /^(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))$/, a = this, c = 0, d = 0, u = !1, p = !1, _ = [], y = {
                data: [],
                errors: [],
                meta: {}
            };
                ...
                t.step = function(e) {
                    ...
                    b())
                        ...
                        0 === y.data.length)
                            return;
                        c += e.data.length,
                        t.preview && c > t.preview ? i.abort() : (y.data = y.data[0],
                        v(y, a))
                    }
                }
            }
            ...
            function C() {
                if (y && o && (I("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + n.DefaultDelimiter + "'"),
                o = !1),
                t.skipEmptyLines)
                    for (var e = 0; e < y.data.length; e++)
                        x(y.data[e]) && y.data.splice(e--, 1);
                return b() && function() {
                    if (!y)
                        return;
                    function e(e, i) {
                        w(t.transformHeader) && (e = t.transformHeader(e, i)),
                        _.push(e)
                    }
                    if (Array.isArray(y.data[0])) {
                        for (var i = 0; b() && i < y.data.length; i++)
                            y.data[i].forEach(e);
                        y.data.splice(0, 1)
                    } else
                        y.data.forEach(e)
                ...
                function() {
                    if (!y || !t.header && !t.dynamicTyping && !t.transform)
                        return y;
                    function e(e, i) {
                        var o, s = t.header ? {} : [];
                        for (o = 0; o < e.length; o++) {
                            var n = o
                              , r = e[o];
                            t.header && (n = o >= _.length ? "__parsed_extra" : _[o]),
                            t.transform && (r = t.transform(r, n)),
                            r = S(n, r),
                            "__parsed_extra" === n ? (s[n] = s[n] || [],
                            s[n].push(r)) : s[n] = r
                        }
                        return t.header && (o > _.length ? I("FieldMismatch", "TooManyFields", "Too many fields: expected " + _.length + " fields but parsed " + o, d + i) : o < _.length && I("FieldMismatch", "TooFewFields", "Too few fields: expected " + _.length + " fields but parsed " + o, d + i)),
                        s
                    }
                    var i = 1;
                    !y.data.length || Array.isArray(y.data[0]) ? (y.data = y.data.map(e),
                    i = y.data.length) : y.data = e(y.data, 0);
            ...
            function S(e, i) {
                return function(e) {
                    return t.dynamicTypingFunction && void 0 === t.dynamicTyping[e] && (t.dynamicTyping[e] = t.dynamicTypingFunction(e)),
                    !0 === (t.dynamicTyping[e] || t.dynamicTyping)
            ...
            this.parse = function(s, r, l) {
                ...
                o = !1,
                t.delimiter)
                    w(t.delimiter) && (t.delimiter = t.delimiter(s),
                    y.meta.delimiter = t.delimiter);
                else {
                        ...
                        for (var d = 0; d < r.length; d++) {
                            ...
                            for (var y = new g({
                                ...
                                if (o && x(y.data[v]))
                                    ...
                                    f += m,
                                    void 0 !== a ? m > 0 && (p += Math.abs(m - a),
                                    a = m) : a = m
                                }
                            y.data.length > 0 && (f /= y.data.length - _),
                            (void 0 === h || p <= h) && (void 0 === c || f > c) && f > 1.99 && (h = p,
                            l = u,
                            c = f)
                        }
                    ...
                    a.successful ? t.delimiter = a.bestDelimiter : (o = !0,
                    t.delimiter = n.DefaultDelimiter),
                    y.meta.delimiter = t.delimiter
                }
                var c = m(t);
                return t.preview && t.header && c.preview++,
                e = s,
                i = new g(c),
                y = i.parse(e, r, l),
                C(),
            ...
            this.pause = function() {
                u = !0,
                i.abort(),
                e = w(t.chunk) ? "" : e.substring(i.getCharIndex())
            }
            ,
            this.resume = function() {
                a.streamer._halted ? (u = !1,
                a.streamer.parseChunk(e, !0)) : setTimeout(a.resume, 3)
            }
            ,
        ...
        function g(t) {
            var e, i = (t = t || {}).delimiter, o = t.newline, s = t.comments, r = t.step, l = t.preview, h = t.fastMode, a = e = void 0 === t.quoteChar ? '"' : t.quoteChar;
            if (void 0 !== t.escapeChar && (a = t.escapeChar),
            ("string" != typeof i || n.BAD_DELIMITERS.indexOf(i) > -1) && (i = ","),
            s === i)
            ...
            this.parse = function(t, n, u) {
                ...
                for (var R = t.indexOf(i, c), L = t.indexOf(o, c), P = new RegExp(f(a) + f(e),"g"), N = t.indexOf(e, c); ; )
                    if (t[c] !== e)
                        if (s && 0 === C.length && t.substring(c, c + y) === s) {
                            ...
                            C.push(t.substring(c, R)),
                            c = R + g,
                            R = t.indexOf(i, c);
                        else {
                            if (-1 === L)
                                break;
                            if (C.push(t.substring(c, L)),
                            F(L + _),
                            v && (M(),
                            d))
                                return E();
                        ...
                        c++; ; ) {
                            if (-1 === (N = t.indexOf(e, N + 1)))
                                ...
                                T();
                            if (N === p - 1)
                                return T(t.substring(c, N).replace(P, e));
                            if (e !== a || t[N + 1] !== a) {
                                if (e === a || 0 === N || t[N - 1] !== a) {
                                    -1 !== R && R < N + 1 && (R = t.indexOf(i, N + 1)),
                                    -1 !== L && L < N + 1 && (L = t.indexOf(o, N + 1));
                                    var k = A(-1 === L ? R : Math.min(R, L));
                                    if (t.substr(N + 1 + k, g) === i) {
                                        C.push(t.substring(c, N).replace(P, e)),
                                        c = N + 1 + k + g,
                                        t[N + 1 + k + g] !== e && (N = t.indexOf(e, c)),
                                        R = t.indexOf(i, c),
                                        L = t.indexOf(o, c);
                                        break
                                    }
                                    ...
                                    if (t.substring(N + 1 + H, N + 1 + H + _) === o) {
                                        if (C.push(t.substring(c, N).replace(P, e)),
                                        F(N + 1 + H + _),
                                        R = t.indexOf(i, c),
                                        N = t.indexOf(e, c),
                                        v && (M(),
                ...
                function T(e) {
                    return u || (void 0 === e && (e = t.substring(c)),
                    C.push(e),
                    c = p,
                    z(C),
                    v && M()),
        ...
        function _(t) {
            ...
            if (e.error)
                ...
                if (w(i.userStep)) {
                    ...
                    w(i.userChunk) && (i.userChunk(e.results, n, e.file),
                    delete e.results)
            }
        ...
        function y(t, e) {
            var i = o[t];
            w(i.userComplete) && i.userComplete(e),
            i.terminate(),
            delete o[t]
        }
        function v() {
        ...
        "undefined" == typeof PAPA_BROWSER_CONTEXT && (u.prototype = Object.create(l.prototype),
      ...
      , Kr = {
        inputBar: {
            ...
            events: {
                ready: function(t, e) {
                    ...
                    setTimeout((function() {
                        if (null != i._cellCursorPosition) {
                            i.getRowIdByCoord(i._cellCursorPosition.y),
                            i.getColIdByCoord(i._cellCursorPosition.x);
                            t.inputField.value = i.getCellValue(i._cellCursorPosition),
                            t.inputInfo.textContent = i.getSpreadsheetCoords(i._cellCursorPosition)
                        }
                    }
                    ), 0)
                },
                setselection: function(t, e) {
                    var i = this;
                    setTimeout((function() {
                        i.getRowIdByCoord(e.cellCursorPosition.y),
                        i.getColIdByCoord(e.cellCursorPosition.x);
                        t.inputField.value = i.getCellValue(e.cellCursorPosition),
                        t.inputInfo.textContent = i.getSpreadsheetCoords(e.cellCursorPosition)
                    }
                    ), 0)
                },
            ...
            listeners: {
                ...
                "inputField.focus": function(t, e) {
                    t.inputWrapper.classList.add("dgxl-hasFocus"),
                    P(t.inputWrapper, Y[".dgxl-inputWrapper.dgxl-hasFocus"].call(this))
                },
                "inputField.blur": function(t, e) {
                    t.inputWrapper.classList.remove("dgxl-hasFocus"),
                    P(t.inputWrapper, Y["reset|.dgxl-inputWrapper.dgxl-hasFocus"].call(this))
                }
            },
            keys: {
        ...
        searchBar: {
            ...
            update: function(t) {
                ...
                this._searchCellsFound.length ? (t.inputInfo.textContent = this.getLocaleSetting(e),
                t.searchCellButtonNext.removeAttribute("disabled"),
                t.searchCellButtonPrev.removeAttribute("disabled")) : (this._searchStr ? t.inputInfo.textContent = this.getLocaleSetting(e) : t.inputInfo.textContent = "",
                t.searchCellButtonNext.setAttribute("disabled", !0),
        ...
        fullscreenButton: {
            ...
            events: {
                fullscreenenter: function(t) {
                    this.constructor._isIOS && t.fullscreenButton.setAttribute("disabled", !0),
                    t.fullscreenButton.innerHTML = t.fullscreenButton._iconLeave
                },
                fullscreenleave: function(t) {
                    this.constructor._isIOS && t.fullscreenButton.removeAttribute("disabled"),
                    t.fullscreenButton.innerHTML = t.fullscreenButton._iconEnter
                }
            }
        },
        credits: {
            ...
            node: function() {
                ...
                return {
                    ...
                    html: '<a id="download_csv" style="display:flex;height:100%;aspect-ratio:1;" title="Download CSV"><img onclick="grid.downloadDataAsCSV();" style="height:100%;aspect-ratio:1;" src="' + t + '"></a>'
                }
            }
        }
    }
    ...
    function Ur() {
        if (null == this._cellCursorPosition)
            var t = null;
        else
            t = [this.getRowIdByCoord(this._cellCursorPosition.y), this.getColIdByCoord(this._cellCursorPosition.x)];
        for (var e = {
            selection: [],
    ...
    var qr = function(t) {
        for (var e = [], i = t[0].x; i <= t[1].x; i++)
            e.push(this.getColIdByCoord(i));
        return e
    }
      , Gr = function(t) {
        for (var e = [], i = t[0].y; i <= t[1].y; i++)
            e.push(this.getRowIdByCoord(i));
        return e
    }
      , Zr = {
        cut: {
      ...
      , $r = {
        ...
        letters: {
            indexToLabel: function(t) {
                var e = "";
                for (t++; t-- > 0; t = (t - t % 26) / 26)
                    e = String.fromCharCode(t % 26 + 65) + e;
                return e
            },
            labelToIndex: function(t) {
                for (var e = 0, i = 0; i < t.length; i++)
                    e = 26 * e + t.charCodeAt(i) - 64;
                return e - 1
            }
        }
    }
      , Qr = ["searchBar"]
      , Jr = ["fullscreenButton", "inputBar", "credits"];
    function tl(t, e, i, o) {
    ...
    function ul(t, e, i, o) {
        ...
        l.length && a.unshift(l[0]),
        a.sort((function(t, e) {
            return t.range[0].y - e.range[0].y
        }
        ));
        for (var c = 0; c < a.length; c++) {
            for (var d = n.length, u = 0; u < a[c].rowIds.length; u++)
                n.indexOf(a[c].rowIds[u]) > -1 ? "rowStartIndex"in a[c] || (a[c].rowStartIndex = n.indexOf(a[c].rowIds[u])) : n.push(a[c].rowIds[u]);
        ...
        for (c = 0; c < a.length; c++) {
            var p = s.length;
            for (u = 0; u < a[c].colIds.length; u++)
                s.indexOf(a[c].colIds[u]) > -1 ? "colStartIndex"in a[c] || (a[c].colStartIndex = s.indexOf(a[c].colIds[u])) : s.push(a[c].colIds[u]);
        ...
        for (c = 0; c < a.length; c++)
            for (var f = a[c].rowStartIndex, g = a[c].colStartIndex, _ = 0, y = 0, v = a[c].range[0].y; v <= a[c].range[1].y; v++) {
                y = 0;
                for (var m = a[c].range[0].x; m <= a[c].range[1].x; m++)
                    r[f + _][g + y] = a[c].values[_][y],
                    y++;
                _++
            }
        var x = [];
        for (c = 0; c < a.length; c++)
            "action"in a[c] && "cut" == a[c].action || x.push({
                range: a[c].range,
                type: "cell"
            });
        return {
    ...
    var pl = function(t) {
        for (var e, i = this._cols.store._lastId, o = [], s = t[0].x; s <= t[1].x; s++)
            null == (e = this.getColIdByCoord(s)) && i++,
            o.push(e || i);
        return o
    }
      , fl = function(t) {
        for (var e, i = this._rows.store._lastId, o = [], s = t[0].y; s <= t[1].y; s++)
            null == (e = this.getRowIdByCoord(s)) && i++,
            o.push(e || i);
        return o
    }
      , gl = function(t, i, o) {
        for (var s, n, r, l = [], h = 0; h < t.length; h++) {
            ...
            this.expandSheetOnPaste || (a[1].y = Math.min(a[1].y, this._rows.coordList.length - 1),
            a[1].x = Math.min(a[1].x, this._cols.coordList.length - 1)),
            n = fl.call(this, a),
            r = pl.call(this, a),
            s = e(i) ? i.length != n.length || i[0].length != r.length ? yl(a, i) : i : _l(a, i),
            l.push({
                range: a,
                rowIds: n,
                colIds: r,
    ...
    function vl(t, e) {
        for (var i = [], o = this._cols.store._lastId, s = 0; s < t; s++)
            o++,
            this._cols.store.push({
                id: o,
                field: void 0,
        ...
        for (var n = 0; n < this._rows.store.length; n++)
            for (s = 0; s < i.length; s++)
                this._cellStore[this._rows.store[n].id - 1][i[s] - 1] = {
                    value: null
                };
        if (e)
            r = this._cols.indexList.indexOf(e) + 1;
        else
            var r = 0;
        this._cols.indexList.splice.apply(this._cols.indexList, [r, 0].concat(i));
        for (s = 0; s < i.length; s++)
            ii.call(this, 100, i[s]);
        return i
    }
    function ml(t, e) {
        for (var i = [], o = this._rows.store._lastId, s = 0; s < t; s++)
            o++,
            this._rows.store.push({
                id: o,
                title: void 0,
        ...
        for (var n = 0; n < this._cols.store.length; n++)
            for (s = 0; s < i.length; s++)
                null == this._cellStore[i[s] - 1] && (this._cellStore[i[s] - 1] = []),
                this._cellStore[i[s] - 1][this._cols.store[n].id - 1] = {
                    value: null
                };
        if (e)
            r = this._rows.indexList.indexOf(e) + 1;
        else
            var r = 0;
        return this._rows.indexList.splice.apply(this._rows.indexList, [r, 0].concat(i)),
        i
    }
    function xl(t) {
        for (var e = [], i = 0; i < t.length; i++) {
            ...
            this._cols.indexList.splice(o, 1),
            e.push({
                id: t[i],
                index: o
            })
    ...
    function wl(t) {
        for (var e = [], i = 0; i < t.length; i++) {
            ...
            this._rows.indexList.splice(o, 1),
            e.push({
                id: t[i],
                index: o
            })
    ...
    function Cl(t) {
        for (var e = 0; e < t.length; e++)
            delete this._cols.store[t[e].id - 1]._deleted,
            this._cols.indexList.splice(t[e].index, 0, t[e].id)
    }
    function bl(t) {
        for (var e = 0; e < t.length; e++)
            delete this._rows.store[t[e].id - 1]._deleted,
            this._rows.indexList.splice(t[e].index, 0, t[e].id)
    }
    function Sl(t) {
    ...
    function Il(t, e, i, o) {
        ...
        null != t) {
            ...
            t = al.call(this, t);
            this._activeRangeIndex = Math.min(i, t.length - 1),
            this._cellCursorPosition = null == e ? t[this._activeRangeIndex].range[0] : Is.call(this, e),
            this._selection = t,
            this.constructor.contextMenu.isOpen() && this.constructor.contextMenu._context == this || kn.call(this),
            this.constructor._isTouchDevice || wi.call(this),
            this.activate(),
            this.events.dispatch("setselection", {
    ...
    function Rl(t, e) {
        ...
        var o = this._viewportPosition.y + (this._rowView.length - 1);
        if (this._rowViewOverflow > 0 && (o -= 1),
        t.x < this._viewportPosition.x)
            var s = t.x - this._viewportPosition.x;
        else if (t.x > i)
            s = t.x - i;
        if (t.y < this._viewportPosition.y)
            var n = t.y - this._viewportPosition.y;
        else if (t.y > o)
            n = t.y - o;
        return {
            x: ("xy" == e || "x" == e) && s || 0,
    ...
    function Ll(t) {
        var e = {
          ...
          , i = Rl.call(this, t);
        t.x >= this._panesXids.left.length && (e.x += i.x),
        t.y >= this._panesYids.top.length && (e.y += i.y),
        tn.call(this, e)
    }
    function Pl(t) {
        if (null != t && t.selection.length) {
            ...
            Il.call(this, e, t.cellCursorPosition, t.activeRangeIndex),
            Ll.call(this, this._cellCursorPosition)
        }
    }
    function Nl() {
    ...
    function kl() {
        this._domNodes.component.style.width = this._cd.componentWidth + "px",
        this._domNodes.component.style.height = this._cd.componentHeight + "px",
        this._domNodes.display.style.width = this._cd.displayWidth + "px",
        this._domNodes.display.style.height = this._cd.displayHeight + "px",
        this._domNodes.viewport.style.width = this._cd.viewportWidth + "px",
        this._domNodes.viewport.style.height = this._cd.viewportHeight + "px",
        this._domNodes.eventArea.style.width = this._cd.scrollAreaWidth + "px",
        this._domNodes.eventArea.style.height = this._cd.scrollAreaHeight + "px",
        this._domNodes.scrollArea.style.width = this._cd.scrollAreaWidth + "px",
        this._domNodes.scrollArea.style.height = this._cd.scrollAreaHeight + "px",
        this._domNodes.scrollSurface.style.width = this._cd.scrollWidth + "px",
        this._domNodes.scrollSurface.style.height = this._cd.scrollHeight + "px",
        this._domNodes.actionRangesContainer.style.width = this._cd.viewportWidth + "px",
        this._domNodes.actionRangesContainer.style.height = this._cd.viewportHeight + "px",
        this._domNodes.panes.style.height = this._cd.viewportHeight + "px",
        this._domNodes.panes.style.width = this._cd.viewportWidth + "px",
        this._domNodes["pane-left"].style.height = this._cd.viewportHeight + "px",
        this._domNodes["pane-left"].style.width = this._cd.panesX.left.space + "px",
        this._domNodes["pane-center"].style.left = this._cd.panesX.center.offset + "px",
        this._domNodes["pane-center"].style.height = this._cd.viewportHeight + "px",
        this._domNodes["pane-center"].style.width = this._cd.panesX.center.space + "px",
        this._domNodes.hintsContainer.style.width = this._cd.viewportWidth + "px",
        this._domNodes.hintsContainer.style.height = this._cd.viewportHeight + "px",
        Ml.call(this),
        Bl.call(this),
        Hl.call(this),
        zl.call(this),
    ...
    var Hl = function() {
      ...
      , Tl = function() {
        this._domNodes.gridLines.style.width = this._cd.viewportWidth + "px",
        this._domNodes.gridLines.style.height = this._cd.viewportHeight + "px",
        this._domNodes.rowLines.style.width = this._cd.viewportWidth + "px",
        this._domNodes.colLines.style.height = this._cd.viewportHeight + "px"
    }
      , Fl = function() {
        ...
        P(this._domNodes.background["top-left"], {
            width: this._cd.panesX.left.space - this._cd.rowHeaderSpace + "px",
      ...
      , El = function() {
        for (var t in this._domNodes.canvas) {
            ...
            h._displayWidth = r,
            h._displayHeight = l,
            h._drawWidth = h._displayWidth / 1,
            h._drawHeight = h._displayHeight / this.rowHeight,
            h.width = h._drawWidth,
            h.height = h._drawHeight
        }
    }
      , Ml = function() {
        this._domNodes.rowHeaderColumn.style.height = this._cd.viewportHeight + "px",
        this._domNodes["column-center"].style.top = this._cd.panesY.center.offset - this._cd.colHeaderSpace + "px",
        this._domNodes["column-center"].style.height = this._cd.panesY.center.space + "px";
        for (var t = 0; t < this._columnNodes.length; t++)
            this._columnNodes[t].column.style.height = this._cd.viewportHeight + "px",
            this._columnNodes[t]["column-top"].style.height = this._cd.panesY.top.outer - this._cd.colHeaderSpace + "px",
            this._columnNodes[t]["column-center"].style.height = this._cd.panesY.center.space + "px"
    }
      , Bl = function() {
        this._domNodes.freezeLines.style.height = this._cd.viewportHeight + "px",
        this._domNodes.freezeLines.style.width = this._cd.viewportWidth + "px",
        this._domNodes.placeholderFreezeLines.style.height = this._cd.viewportHeight + "px",
        this._domNodes.placeholderFreezeLines.style.width = this._cd.viewportWidth + "px",
        null == this._freezeLineRowAfterId ? P(this._domNodes["freezeLine-row"], {
        ...
        if (t = t.toLowerCase()) {
            for (var o = 0; o < this._rows.coordList.length; o++)
                for (var s = 0; s < this._cols.coordList.length; s++) {
                    ...
                    null != n.value && String(n.value).toLowerCase().indexOf(t) > -1 && (n._found = t,
                    e.push([this._rows.coordList[o], this._cols.coordList[s]]))
                }
            e.length && (i = 0)
        }
        this._searchStr = t,
        this._searchCellsFound = e,
        this._searchCellIndex = i
    }
    function Dl(t) {
        var e = this;
        if (void 0 === t && (t = ""),
        ...
        var s = !1
          , n = !1;
        ("hideCols" == t && this._viewportPosition.x == this._panesXids.left.length || "freezeCols" == t) && (s = !0),
        ("hideRows" == t && this._viewportPosition.y == this._panesYids.top.length || "freezeRows" == t) && (n = !0),
        Bt.call(this),
        Vt.call(this, s, n),
        Nl.call(this),
        kl.call(this),
        "search" != t && this._searchStr && Ol.call(this, this._searchStr);
        for (i = 0; i < this._validatedTopBar.length; i++)
            "update"in this._validatedTopBar[i] && this._validatedTopBar[i].update.call(this, this._topBarNodes[i].nodes);
        for (i = 0; i < this._validatedBottomBar.length; i++)
            "update"in this._validatedBottomBar[i] && this._validatedBottomBar[i].update.call(this, this._bottomBarNodes[i].nodes);
        setTimeout((function() {
            $s.call(e)
        }
        ), 0)
    ...
    function Vl(t, e, i) {
        ...
        var o, s = Ur.call(this), n = [], r = [], l = [], h = [], a = [], c = function(t, e, i, s) {
            if (void 0 === t && (t = "do"),
            void 0 === i && (i = function() {}
            ),
            void 0 === s && (s = null),
            this.events.dispatch("beforesetcellvalues", e)) {
                Nl.call(this),
                "do" == t ? (r = Xl.call(this, e),
                l = Yl.call(this, e),
                (r.length || l.length) && Dl.call(this, "insertEmptyItems")) : "undo" == t ? (r.length && (h = xl.call(this, r)),
                l.length && (a = wl.call(this, l))) : "redo" == t && (h.length && Cl.call(this, h),
                a.length && bl.call(this, a),
                (r.length || l.length) && Dl.call(this, "insertEmptyItems")),
                i.call(this),
                null != s && (o = Ur.call(this));
                var c = 0
                  , d = function() {
                    ...
                    if (null != s)
                        do {
                            ...
                            for (var l = [], h = 0; h < o.length; h++)
                                l.push(this._cellStore[e.rowIds[c] - 1][o[h] - 1].value || null);
                            n.push(l),
                            c++
                    ...
                    Dl.call(this, "setCellValues"),
                    this.redraw(),
                    c < e.rowIds.length - 1 ? setTimeout(d, 75) : (this.events.dispatch("setcellvalues", e),
                    null != s && s.call(this))
                }
                .bind(this);
                d()
    ...
    var Xl = function(t) {
        for (var e = 0, i = 0; i < t.colIds.length; i++)
            null == this.getColFromStore(t.colIds[i]) && e++;
        if (e)
            var o = vl.call(this, e, this._cols.coordList[this._cols.coordList.length - 1]);
        return o || []
    }
      , Yl = function(t) {
        for (var e = 0, i = 0; i < t.rowIds.length; i++)
            null == this.getRowFromStore(t.rowIds[i]) && e++;
        if (e)
            var o = ml.call(this, e, this._rows.coordList[this._rows.coordList.length - 1]);
        return o || []
    };
    function Wl(t, e, i, o) {
        if (void 0 === t && (t = null),
        ...
        null != t) {
            ...
            if (o)
                var n = this.constructor._clipboardObject.cellRange
                  , r = ul.call(this, s, e, i, n);
            else
                r = ul.call(this, s, e, i);
            if (i)
                var l = function() {
    ...
    function Kl(t, e, i) {
        ...
        if ("right" == e)
            ...
            for (a = 0; a < d; a++) {
                p.push([]);
                for (l = 0; l < u; l++) {
                    f = 1 + Math.floor(l / n[a].groups.length),
                    g = l % n[a].groups.length;
                    if (s(n[a].groups[g])) {
                        _ = g - n[a].groups[g].startIndex + n[a].groups[g].size * f,
                        y = n[a].groups[g].base + _ * n[a].groups[g].increment;
                        y = Math.round(100 * y) / 100,
                        p[a].unshift(y)
                    } else
                        p[a].unshift(n[a].groups[g])
                }
            }
        else if ("down" == e)
            for (a = 0; a < d; a++) {
                p.push([]);
                for (l = 0; l < u; l++) {
                    f = 1 + Math.floor(a / n[l].groups.length),
                    g = a % n[l].groups.length;
                    if (s(n[l].groups[g])) {
                        _ = g - n[l].groups[g].startIndex + n[l].groups[g].size * f,
                        y = n[l].groups[g].base + _ * n[l].groups[g].increment;
                        y = Math.round(100 * y) / 100,
                        p[a].push(y)
                    } else
                        p[a].push(n[l].groups[g])
                }
            }
        else if ("up" == e)
            for (a = 0; a < d; a++) {
        ...
        Vl.call(this, m, !0, (function() {
            if (Io(this._cellCursorPosition, t))
                var e = this._cellCursorPosition;
            else
                e = null;
            var i, o;
            Il.call(this, [{
    ...
    var jl = function(t) {
        for (var e = 0; e < t.length; e++)
            t[e].groups = i(t[e].series);
        function i(t) {
            for (var e, i, s, n = [], r = null, l = 0; l < t.length; l++)
                e = "" !== (s = t[l]) && null !== s && !isNaN(s) && isFinite(s) && Math.floor(s) === Number(s) ? "number" : "string",
                null == r ? i = [t[l]] : e == r ? i.push(t[l]) : ("number" == r && i.length && (i = o(i, l - i.length)),
                Array.prototype.push.apply(n, i),
                i = [t[l]]),
                r = e;
            return i.length && ("number" == r && i.length && (i = o(i, l - i.length)),
            Array.prototype.push.apply(n, i)),
            n
        }
        function o(t, e) {
    ...
    function ql(t) {
        ...
        for (var i = al.call(this, Ul.call(this, t)), o = new Set, s = 0; s < i.length; s++)
            for (var n = this.getColIndexByCoord(i[s].range[0].x), r = this.getColIndexByCoord(i[s].range[1].x), l = n; l <= r; l++)
                o.add(this._cols.indexList[l]);
    ...
    function Gl(t) {
        void 0 === t && (t = null),
        this.deleteColsById(ql.call(this, t))
    }
    function Zl(t) {
        void 0 === t && (t = 1),
        t = $o(t, 0, this._cols.indexList.length - 1),
        this.freezeColsUntilId(this.getColIdByIndex(t - 1))
    }
    function $l(t) {
        void 0 === t && (t = null),
        this.hideColsById(ql.call(this, t))
    }
    function Ql(t) {
        for (var e = [], i = 0; i < t.length; i++)
            e.push(t[i]);
    ...
    function Jl(t, e, i, o) {
        ...
        if (this.events.dispatch("beforeinsertcols", s)) {
            ...
            i && this.undoManager.add({
                ...
                undo: function() {
                    l = xl.call(this, r),
                    Dl.call(this, "deleteCols"),
                    Pl.call(this, n),
                    this.redraw()
                },
                redo: function() {
                    Cl.call(this, l),
                    Dl.call(this, "restoreDeletedCols"),
                    Pl.call(this, h),
                    this.redraw()
                }
            }),
            s.insertedIds = Ql(r),
            this.events.dispatch("insertcols", s)
        }
    }
    function th(t) {
        e(t) || (t = [t, t]);
    ...
    function eh(t, e) {
        if (void 0 === t && (t = 1),
        void 0 === e && (e = this._cols.coordList.length),
        0 == (e = $o(e, 0, this._cols.coordList.length)))
            var i = 0;
        else
            i = this._cols.coordList[Math.min(this._cols.coordList.length, e) - 1];
    ...
    function ih(t, e) {
        ...
        for (var i, o = [], s = 0; s < e.length; s++)
            o.push(this["_" + t].coordList.indexOf(e[s]));
        o.sort();
        var n = []
          , r = [];
        for (s = 0; s < o.length; s++)
            o[s] == i + 1 || 0 == s ? r.push(o[s]) : (n.push(r),
            r = [o[s]]),
            i = o[s];
        return n.push(r),
        n
    ...
    function sh(t) {
        for (var e = [], i = 0; i < t.length; i++) {
            ...
            this._cols.indexList.splice(o, 1),
            t[i].afterId)
                s = this._cols.indexList.indexOf(t[i].afterId) + 1;
            else
                var s = 0;
    ...
    function nh(t, e, i, o) {
        ...
        if (this.events.dispatch("beforemovecols", s)) {
            var n, r = rh(s.colIds, s.targetId), l = Ur.call(this);
            n = sh.call(this, r),
            Dl.call(this, "moveCols"),
            o.call(this),
            this.redraw();
            var h = Ur.call(this);
            i && this.undoManager.add({
    ...
    function lh(t, e) {
        ...
        null != t && null != e) {
            ...
            if (e = $o(e, 0, this._cols.coordList.length),
            hh.call(this, i, e)) {
                if (0 == e)
                    var o = 0;
                else
                    o = this._cols.coordList[e - 1];
                i.indexOf(o) > -1 || nh.call(this, i, o, !0, (function() {
                    this.setColSelection(oh(ih.call(this, "cols", i)))
                }
                ))
            } else
                this.alertUser("Cannot move columns in or out of the frozen section. Try turning off frozen columns first.")
        }
    }
    var hh = function(t, e) {
        if (this.getColCoordById(t[0]) == e)
            return !0;
        for (var i = !0, o = 0; o < t.length; o++)
            this._cols.coordSections[0].indexOf(t[o]) > -1 && (i = !1);
        return e < this._cols.coordSections[0].length && (i = !1),
        i
    };
    function ah(t, e) {
        for (var i = 0; i < t.length; i++)
            this._columnNodes[t[i] - 1].column.style.width = e[i] + "px"
    }
    function ch(t, e) {
        for (var i = 0; i < t.length; i++)
            void 0 !== e[i] && (this._cols.store[t[i] - 1].width = 1 * Math.round(Math.max(e[i], 32) / 1));
        ah.call(this, t, e)
    }
    function dh(t, e, i, o) {
        void 0 === i && (i = !0),
        ...
        if (this.events.dispatch("beforeresizecols", s)) {
            for (var n = Ur.call(this), r = [], l = 0; l < s.colIds.length; l++)
                r.push(this._cols.store[s.colIds[l] - 1].width);
            ch.call(this, s.colIds, s.widths),
            Dl.call(this, "resizeCols"),
            o.call(this),
            this.redraw();
            var h = Ur.call(this);
            i && this.undoManager.add({
    ...
    function uh(t, e) {
        ...
        void 0 === e && (e = null),
        null != t && null != e) {
            for (var i = ql.call(this, t), o = [], s = 2 * Math.round(Math.max(Math.round(e), 32) / 2), n = 0; n < i.length; n++)
                o.push(s);
            dh.call(this, i, o, !0)
        }
    }
    ...
    function vh(t) {
        if (t.length != this._cols.coordList.length)
            if (JSON.stringify(t) != JSON.stringify(this._cols.indexSections[1])) {
                ...
                this.alertUser("Cannot delete all non-frozen columns.");
        else
            this.alertUser("Cannot delete all columns.")
    }
    function mh(t) {
    ...
    function xh(t, e, i) {
        ...
        if (this.events.dispatch("beforefreezecols", o)) {
            var s = this._freezeLineColAfterId
              , n = Ur.call(this);
            mh.call(this, o.colId),
            Dl.call(this, "freezeCols"),
            i.call(this),
            this.redraw();
            var r = Ur.call(this);
            e && this.undoManager.add({
    ...
    function Ch(t) {
        for (var e = 0; e < t.length; e++)
            this._cols.store[t[e] - 1]._hide = !0
    }
    function bh(t) {
        for (var e = 0; e < t.length; e++)
            this._cols.store[t[e] - 1]._hide = !1
    }
    function Sh(t, e, i) {
        void 0 === e && (e = !0),
        void 0 === i && (i = function() {}
        ...
        if (this.events.dispatch("beforehidecols", o)) {
            var s = Ur.call(this);
            Ch.call(this, o.colIds),
            Dl.call(this, "hideCols"),
            i.call(this),
            this.redraw();
            var n = Ur.call(this);
            e && this.undoManager.add({
                desc: "hideCols",
                undo: function() {
                    bh.call(this, o.colIds),
                    Dl.call(this, "showCols"),
                    Pl.call(this, s),
                    this.redraw()
                },
                redo: function() {
    ...
    function Ih(t) {
        if (t.length != this._cols.coordList.length) {
            ...
            this.alertUser("Cannot hide all columns.")
    }
    function Rh(t, e, i) {
        void 0 === e && (e = !0),
        void 0 === i && (i = function() {}
    ...
    function Nh(t) {
        ...
        for (var i = al.call(this, Ph.call(this, t)), o = new Set, s = 0; s < i.length; s++)
            for (var n = this.getRowIndexByCoord(i[s].range[0].y), r = this.getRowIndexByCoord(i[s].range[1].y), l = n; l <= r; l++)
                o.add(this._rows.indexList[l]);
        return Array.from(o).sort((function(t, i) {
    ...
    function kh(t) {
        void 0 === t && (t = null),
        this.deleteRowsById(Nh.call(this, t))
    }
    function Hh(t) {
        void 0 === t && (t = 1),
        t = $o(t, 0, this._rows.indexList.length - 1),
        this.freezeRowsUntilId(this.getRowIdByIndex(t - 1))
    }
    function zh(t) {
    ...
    function Ah(t, e, i, o) {
        ...
        if (this.events.dispatch("beforeinsertrows", s)) {
            ...
            i && this.undoManager.add({
                ...
                undo: function() {
                    l = wl.call(this, r),
                    Dl.call(this, "deleteRows"),
                    Pl.call(this, n),
                    this.redraw()
                },
                redo: function() {
                    bl.call(this, l),
                    Dl.call(this, "restoreDeletedRows"),
                    Pl.call(this, h),
                    this.redraw()
                }
            }),
            s.insertedIds = Ql(r),
            this.events.dispatch("insertrows", s)
        }
    }
    function Th(t) {
        e(t) || (t = [t, t]);
    ...
    function Fh(t, e) {
        if (void 0 === t && (t = 1),
        void 0 === e && (e = this._rows.coordList.length),
        0 == (e = $o(e, 0, this._rows.coordList.length)))
            var i = 0;
        else
            i = this._rows.coordList[e - 1];
    ...
    function Eh(t) {
        for (var e = [], i = 0; i < t.length; i++) {
            ...
            this._rows.indexList.splice(o, 1),
            t[i].afterId)
                s = this._rows.indexList.indexOf(t[i].afterId) + 1;
            else
                var s = 0;
    ...
    function Mh(t, e, i, o) {
        ...
        if (this.events.dispatch("beforemoverows", s)) {
            var n, r = Bh(s.rowIds, s.targetId), l = Ur.call(this);
            n = Eh.call(this, r),
            Dl.call(this, "moveRows"),
            o.call(this),
            this.redraw();
            var h = Ur.call(this);
            i && this.undoManager.add({
    ...
    function Oh(t, e) {
        ...
        null != t && null != e) {
            ...
            if (e = $o(e, 0, this._rows.coordList.length),
            Dh.call(this, i, e)) {
                if (0 == e)
                    var o = 0;
                else
                    o = this._rows.coordList[e - 1];
                i.indexOf(o) > -1 || Mh.call(this, i, o, !0, (function() {
                    this.setRowSelection(oh(ih.call(this, "rows", i)))
                }
                ))
            } else
                this.alertUser("Cannot move rows in or out of the frozen section. Try turning off frozen rows first.")
        }
    }
    var Dh = function(t, e) {
        if (this.getRowCoordById(t[0]) == e)
            return !0;
        for (var i = !0, o = 0; o < t.length; o++)
            this._rows.coordSections[0].indexOf(t[o]) > -1 && (i = !1);
        return e < this._rows.coordSections[0].length && (i = !1),
        i
    };
    function Vh(t, e, i) {
        void 0 === e && (e = !0),
    ...
    function Wh(t) {
        if (t.length != this._rows.indexList.length)
            if (JSON.stringify(t) != JSON.stringify(this._rows.indexSections[1])) {
                ...
                this.alertUser("Cannot delete all non-frozen rows.");
        else
            this.alertUser("Cannot delete all rows.")
    }
    function Kh(t) {
    ...
    function jh(t, e, i) {
        ...
        if (this.events.dispatch("beforefreezerows", o)) {
            var s = this._freezeLineRowAfterId
              , n = Ur.call(this);
            Kh.call(this, o.rowId),
            Dl.call(this, "freezeRows"),
            i.call(this),
            this.redraw();
            var r = Ur.call(this);
            e && this.undoManager.add({
    ...
    function qh(t) {
        for (var e = 0; e < t.length; e++)
            this._rows.store[t[e] - 1]._hide = !0
    }
    function Gh(t) {
        for (var e = 0; e < t.length; e++)
            this._rows.store[t[e] - 1]._hide = !1
    }
    function Zh(t, e, i) {
        void 0 === e && (e = !0),
        void 0 === i && (i = function() {}
        ...
        if (this.events.dispatch("beforehiderows", o)) {
            var s = Ur.call(this);
            qh.call(this, o.rowIds),
            Dl.call(this, "hideRows"),
            i.call(this),
            this.redraw();
            var n = Ur.call(this);
            e && this.undoManager.add({
                desc: "hideRows",
                undo: function() {
                    Gh.call(this, o.rowIds),
                    Dl.call(this, "showRows"),
                    Pl.call(this, s),
                    this.redraw()
                },
                redo: function() {
    ...
    function $h(t) {
        if (t.length != this._rows.coordList.length) {
            ...
            this.alertUser("Cannot hide all rows.")
    }
    function Qh(t, e, i) {
        void 0 === e && (e = !0),
        void 0 === i && (i = function() {}
    ...
    function na(t) {
        if (!this._sortState.length) {
            this._rowOrderStore = [];
            for (var e = 0; e < this._rows.indexList.length; e++)
                this._rowOrderStore[this._rows.indexList[e] - 1] = this._rows.indexList.length - e
        }
        var i, o = [], s = {};
        for (e = this._rows.coordSections[0].length; e < this._rows.indexList.length; e++)
            if (this._rows.store[this._rows.indexList[e] - 1]._hide)
                s[e] = this._rows.indexList[e];
            else {
                for (var n = [], r = 0; r < t.length; r++)
                    null === (i = this._cellStore[this._rows.indexList[e] - 1][t[r][0] - 1].value) && (i = ""),
                    n.push(String(i));
        ...
        var a = [];
        for (r = 0; r < this._rows.coordSections[0].length; r++)
            a.push(this._rows.coordSections[0][r]);
        for (r = 0; r < o.length; r++)
            a.push(o[r][0]);
        for (var c in s)
            a.splice(c, 0, s[c]);
        this._rows.indexList = a,
        this._sortState = t
    }
    var ra = function(t) {
        for (var e = "return ", i = 0; i < t.length; i++)
            i > 0 && (e += "||"),
            e += "(\n      a[1][" + i + "] === b[1][" + i + "] ? 0 : (\n        a[1][" + i + "] == '' ? 1 : (\n          b[1][" + i + "] == '' ? -1 : (",
            "asc" == t[i][1] ? e += "a[1][" + i + "].localeCompare(b[1][" + i + "], undefined, { numeric: true, sensitivity: 'base' })" : "desc" == t[i][1] && (e += "b[1][" + i + "].localeCompare(a[1][" + i + "], undefined, { numeric: true, sensitivity: 'base' })"),
            e += "))))";
        return e += ";"
    };
    function la() {
        for (var t, e = [], i = 0; i < this._rows.indexList.length; i++)
            t = this._rowOrderStore[this._rows.indexList[i] - 1] || 0,
            e.push([this._rows.indexList[i], t]);
    ...
    function ha(t, e, i) {
        ...
        if (this.events.dispatch("beforesort", o)) {
            ...
            e && this.undoManager.add({
                desc: "sort",
                undo: function() {
                    s.length ? na.call(this, s) : la.call(this),
                    Dl.call(this, "sort"),
                    Pl.call(this, n),
                    this.redraw()
                },
    ...
    function aa(t, e, i) {
        ...
        null != t) {
            var o = this._cols.coordList[t]
              , s = "asc";
            if (null == e ? this._sortState.length && this._sortState[0][0] == o && (s = "asc" == this._sortState[0][1] ? "desc" : "asc") : s = e,
            i && !ca.call(this, o))
                var n = this._sortState;
            else
                n = [];
            n.push([o, s]),
            ha.call(this, n, !0, (function() {}
            ))
        }
    }
    var ca = function(t) {
    ...
    function da() {
        this._isActive = !0,
        mi.call(this, "document", "mousedown"),
        this.keys.resume()
    }
    function ua() {
        this._isActive = !1,
        this._domNodes.cellEditor._isOpen && this.closeCellEditorAndSave(),
        xi.call(this, "document", "mousedown"),
        this.keys.suspend(),
        this.deselectAll()
    }
    function pa(t) {
    ...
    function xa(t) {
        for (var e = 0, i = 0; i < this._cols.coordSections.length; i++)
            if (e += this._cols.coordSections[i].length,
            t.x < e)
                return i;
        return -1
    }
    ...
    function Na(t) {
        for (var e = 0, i = 0; i < this._rows.coordSections.length; i++)
            if (e += this._rows.coordSections[i].length,
            t.y < e)
                return i;
        return -1
    }
    ...
    function Ha() {
        mi.call(this, "cellEditorInputField", "copy"),
        mi.call(this, "cellEditorInputField", "paste"),
        mi.call(this, "cellEditorInputField", "cut"),
        this._domNodes.cellEditor._isOpen = !1,
        this._domNodes.cellEditor._coords = null,
        this._domNodes.cellEditor._mode = null,
    ...
    function za() {
        this.setCellValues(this._domNodes.cellEditor._coords, this._domNodes.cellEditorInputField.value),
        this.closeCellEditor()
    }
    function Aa(t) {
        void 0 === t && (t = "edit"),
        xi.call(this, "cellEditorInputField", "copy"),
        xi.call(this, "cellEditorInputField", "paste"),
        xi.call(this, "cellEditorInputField", "cut"),
        Ll.call(this, this._cellCursorPosition);
        ...
        this._domNodes.cellEditor._mode = t,
        this._domNodes.cellEditor._isOpen = !0,
        "enter" == t ? to.call(this, "inputModeEnter") : (to.call(this, "inputModeEdit"),
        this._domNodes.cellEditorInputField.value = this.getCellValue(this._cellCursorPosition)),
        "edit" == t && (this._isIE || this._isIOS || this._isMacOS)) {
            var o = this._domNodes.cellEditorInputField.value;
            this._domNodes.cellEditorInputField.value = "",
            this._domNodes.cellEditorInputField.value = o
        }
        io.call(this),
        this.redraw()
    }
    function Ta(t) {
        this._domNodes.cellEditorInputField.value = t,
        this._domNodes.cellEditorInputField.dispatchEvent(new Event("input"))
    }
    function Fa() {
        var t = document.createElement("textArea");
        t.value = " all",
        t.setAttribute("readonly", !0),
        t.addEventListener("copy", this._domNodes.component._listeners.clipboardNode.events.copy),
    ...
    function Ea() {
        wi.call(this, !0),
        this._domNodes.cellEditor._actualCommand = "copy",
        this.constructor._isIOS ? Fa.call(this) : document.execCommand("copy")
    }
    function Ma() {
        wi.call(this, !0),
        this._domNodes.cellEditor._actualCommand = "cut",
        this.constructor._isIOS ? Fa.call(this) : document.execCommand("copy")
    }
    function Ba() {
        var t = this;
        ...
        )) : this.isIE ? document.execCommand("paste") : this.alertUser("Paste not available.")
    }
    function Oa() {
    ...
    function Da(t) {
        ...
        for (var e = "", i = 0; i < this._rows.coordList.length; i++) {
            for (var o = 0; o < this._cols.coordList.length; o++) {
                ...
                e += null == s ? "" : s,
                o < this._cols.coordList.length - 1 && (e += ",")
            }
            e += "\n"
        }
        Va.call(this, e)
    ...
    var Va = function(t) {
        ...
        if (this.constructor._isIE)
            navigator.msSaveBlob(e, "datagridxl.csv");
        else {
            var i = H("a", {
            ...
            i.textContent = "Click here to download",
            this._domNodes.component.appendChild(i),
            i.click(),
            this._domNodes.component.removeChild(i)
        }
    };
    function Xa(t) {
        void 0 === t && (t = {});
    ...
    var Ya = function(t) {
        ...
        if (this.constructor._isIE)
            navigator.msSaveBlob(e, "datagridxl.json");
        else {
            var i = H("a", {
                class: "dgxl-downloadLink",
                href: URL.createObjectURL(e),
    ...
    function Ka(t) {
        if (null == t)
            return "";
        if (this.escapeQuotesOnCopy)
            var e = this.textParser.unparse(this.getCellRangeData(t), {
                delimiter: "\t"
            });
        else {
            e = "";
            for (var i = t[0].y; i <= t[1].y; i++) {
                for (var o = t[0].x; o <= t[1].x; o++)
                    e += this._cellStore[this._rows.coordList[i] - 1][this._cols.coordList[o] - 1].value || "",
                    o < t[1].x && (e += "\t");
                i < t[1].y && (e += "\n")
            }
        }
    ...
    function Ua(t) {
        ...
        if ("objectCollection" == this._dataFormat)
            ...
            for (i = 0; i < this._rows.coordList.length; i++) {
                for (o = [],
                s = 0; s < this._cols.coordList.length; s++) {
    ...
    var Ga = function() {
        if (this.constructor._isIOS)
            this._domNodes.component.style.width = "100vw",
            this._domNodes.component.style.height = "100vh";
            ...
            if (e < 100)
                var o = screen.availHeight;
            else
                o = screen.availHeight - e;
            this._domNodes.component.style.width = i + "px",
            this._domNodes.component.style.height = o + "px"
        }
    ...
    var tc = function(t) {
        ...
        if (this.constructor._isIE)
            navigator.msSaveBlob(e, "datagridxl.css");
        else {
            var i = H("a", {
                class: "dgxl-downloadLink",
                href: URL.createObjectURL(e),
    ...
    function ic() {
        ...
        Xt.call(this),
        kl.call(this),
        this._isFullscreen && i == this._cd.componentWidth && e > this._cd.componentHeight + 200 ? o = !0 : this._isFullscreen && i == this._cd.componentWidth && this._cd.componentHeight > e + 200 && (s = !0),
        s || o || tn.call(this, {
            x: this._panesXids.left.length,
            y: this._panesYids.top.length
        }),
    ...
    function oc(t, e) {
        ...
        return i = t in this.locale && null !== this.locale[t] ? this.locale[t] : t in this._defaultLocale && null !== this._defaultLocale[t] ? this._defaultLocale[t] : t,
        sc.call(this, i, o, e)
    }
    var sc = function(t, e, i) {
        var o = i ? "<em>" : ""
          , s = i ? "</em>" : "";
        for (var n in e)
            t = t.replace(n, o + e[n] + s);
        return t
    };
    function nc() {
        this._selection = [],
        this._activeRangeIndex = -1,
        this._cellCursorPosition = null,
        this.redraw()
    }
    function rc(t) {
        for (var e = [], i = 0; i < this._selection.length; i++)
            Io(t, this._selection[i].range) && e.push({
    ...
    var cc = function(t) {
        if ("left" == t || "right" == t) {
            var e, i = this._selection[this._activeRangeIndex].range, o = {
                x: this._cellCursorPosition.x,
                y: this._cellCursorPosition.y
            }, s = i;
            "right" == t ? o.x == i[0].x ? (s[0].x = i[0].x,
            s[1].x = i[1].x + 1,
            e = 1) : (s[0].x = i[0].x + 1,
            s[1].x = i[1].x,
            e = 0) : "left" == t && (o.x == i[1].x ? (s[0].x = i[0].x - 1,
            s[1].x = i[1].x,
            e = 0) : (s[0].x = i[0].x,
            s[1].x = i[1].x - 1,
            e = 1));
            var n = this._selection;
            n[this._activeRangeIndex].range = s,
            Il.call(this, n, o, this._activeRangeIndex);
            var r = Rl.call(this, {
                x: s[e].x,
                y: s[e].y
            }, "x");
      ...
      , dc = function(t) {
        if ("up" == t || "down" == t) {
            ...
            "down" == t ? o.y == i[0].y ? (s[0].y = i[0].y,
            s[1].y = i[1].y + 1,
            e = 1) : (s[0].y = i[0].y + 1,
            s[1].y = i[1].y,
            e = 0) : "up" == t && (o.y == i[1].y ? (s[0].y = i[0].y - 1,
            s[1].y = i[1].y,
            e = 0) : (s[0].y = i[0].y,
            s[1].y = i[1].y - 1,
            e = 1));
      ...
      , uc = function(t) {
        var e, i, o = this._selection[this._activeRangeIndex].range, s = {
            x: this._cellCursorPosition.x,
            y: this._cellCursorPosition.y
        }, n = o;
        "right" == t ? (e = "x",
        ...
        n[0].x = o[0].x,
        n[1].x = o[1].x,
        s.y == o[1].y ? (n[0].y = o[0].y - 1,
        n[1].y = o[1].y,
        i = 0) : (n[0].y = o[0].y,
        n[1].y = o[1].y - 1,
        i = 1));
        var r = this._selection;
        r[this._activeRangeIndex].range = n,
        Il.call(this, r, s, this._activeRangeIndex);
        var l = Rl.call(this, {
            x: n[i].x,
            y: n[i].y
        }, e);
    ...
    function fc(t, e) {
        ...
        null != t) {
            ...
            if (e || !Io(i, this._selection[this._activeRangeIndex].range))
                var o = cl.call(this, i);
            else
                o = this._selection;
            Il.call(this, o, i, 0),
            this.redraw()
    ...
    function gc(t) {
        ...
        var i = {
          ...
          , o = Rl.call(this, e);
        e.x >= this._panesXids.left.length && (i.x += o.x),
        e.y >= this._panesYids.top.length && (i.y += o.y),
        tn.call(this, i),
        this.redraw()
    }
    function _c(t) {
        ...
        null != t) {
            ...
            if (1 == this._selection.length && Di.call(this, e)) {
                ...
                n.right && n.bottom && (this._activeRangeIndex == this._selection.length - 1 ? l = 0 : l++,
                r = this._selection[l].range[0]),
                n.left && n.top && (0 == this._activeRangeIndex ? l = this._selection.length - 1 : l--,
                r = this._selection[l].range[1]),
                Il.call(this, this._selection, r, l)
            }
            var h = {
                x: this._viewportPosition.x,
                y: this._viewportPosition.y
              ...
              , a = Rl.call(this, r);
            r.x >= this._panesXids.left.length && (h.x += a.x),
            r.y >= this._panesYids.top.length && (h.y += a.y),
            tn.call(this, h),
            this.redraw()
        }
    }
    function yc() {
        ...
        t < 0 && (t = 0);
        for (var e = 0, i = this._viewportPosition.y; e < this._cd.panesY.center.space && -1 != i; )
            e += this.getRowHeightById(this.getRowIdByCoord(i)),
            i--;
        var o = {
            x: this._cellCursorPosition.x,
    ...
    function Lc(t, e) {
        ...
        if (e) {
            ...
            (o = this._selection)[this._activeRangeIndex].range = s,
            Il.call(this, o, i, this._activeRangeIndex)
        }
        this.redraw()
    }
    function Pc(t) {
    ...
    function Nc(t) {
        for (var e = {
            x: t,
            y: 0
        }, i = [], o = 0; o < this._selection.length; o++)
            Io(e, this._selection[o].range) && "col" == this._selection[o].type && i.push({
    ...
    function Ac(t, e) {
        ...
        if (e) {
            ...
            (s = this._selection)[this._activeRangeIndex].range = n,
            Il.call(this, s, i, this._activeRangeIndex)
        }
        this.redraw()
    }
    function Tc(t) {
    ...
    function Fc(t) {
        for (var e = {
            ...
            Io(e, this._selection[o].range) && "row" == this._selection[o].type && i.push({
                range: this._selection[o].range,
                type: this._selection[o].type,
                index: o
            });
    ...
    function Kc() {
        this.undoManager.hasUndo() && (this.undoManager.undo(),
        this._isUndo = !0)
    }
    function jc() {
        this.undoManager.hasRedo() && (this.undoManager.redo(),
        this._isRedo = !0)
    }
    function Uc() {
    ...
    var Gc = function(t, e) {
        void 0 === t && (t = null),
        void 0 === e && (e = {}),
        this._presetContextMenuItems = Zr,
        this._presetContextMenuTouchItems,
        this._presetKeyActions = jr,
        this._presetParts = Kr,
        this._defaultTheme = sl,
        this._defaultLocale = nl,
        this.events = new Yt(this),
        this.keys = new zr(this),
        this.undoManager = new Vr(this),
        this.textParser = Wr,
        this.mouseCursorStatesIdle = rl,
        this.mouseCursorStatesDrag = ll,
        this.headerLabelSeries = $r,
        this.keyActionSets = il,
        this.allowEditCells = !0,
        this.allowFillCells = !0,
        this.fillCellsDirection = "xy",
        this.allowCopy = !0,
        this.allowCut = !0,
        this.allowPaste = !0,
        this.expandSheetOnPaste = !0,
        this.instantCut = !1,
        this.allowDeleteCols = !0,
        this.allowInsertCols = !0,
        this.allowMoveCols = !0,
        this.allowFreezeCols = !0,
        this.allowHideCols = !0,
        this.allowResizeCols = !0,
        this.allowDeleteRows = !0,
        this.allowInsertRows = !0,
        this.allowMoveRows = !0,
        this.allowFreezeRows = !0,
        this.allowHideRows = !0,
        this.allowSort = !0,
        this.instantActivate = !1,
        this.colAlign = "left",
        this.colHeaderHeight = 28,
        this.colHeaderLabelAlign = "left",
        this.colHeaderLabelFunction = tl,
        this.colHeaderLabelPrefix = "",
        this.colHeaderLabelSuffix = "",
        this.colHeaderLabelType = "letters",
        this.colWidth = 100,
        this.frozenCols = 0,
        this.frozenRows = 0,
        this.rowHeaderLabelAlign = "right",
        this.rowHeaderLabelFunction = el,
        this.rowHeaderLabelPrefix = "",
        this.rowHeaderLabelSuffix = "",
        this.rowHeaderLabelType = "numbers",
        this.rowHeaderWidth = 50,
        this.rowHeight = 28,
        this.columns = void 0,
        this.contextMenuItems = ol,
        this.contextMenuTouchItems = void 0,
        this.data = void 0,
        this.fontSize = 13,
        ...
        this.topBar = Qr,
        this.bottomBar = Jr,
        this.hijackNativeSearchCommand = !1,
        this.escapeQuotesOnCopy = !1,
        this.cacheCredits = !0,
        this.cssTheme = "light",
        this.theme = {},
        this._dataFormat,
        this._actualRowHeight,
        this._scrollLeft = 0,
        this._scrollTop = 0,
        this._cd = {},
        this._domNodes = {},
        ...
        this._activeRangeIndex = 0,
        this._viewportPosition = null,
        this._viewportOverflowPx = {
            x: 0,
            y: 0
        },
        this._isViewportConnectedTo = {
        ...
        this._isActive = !1,
        this._commandKey = this.constructor._isMacOS ? "metaKey" : "ctrlKey",
        this._searchStr = "",
        this._searchCellsFound = [],
        this._searchCellIndex = -1,
        this._sortState = [],
        this._sortFunctions = {
    ...
    return Gc.prototype.clearCellValues = function(t) {
        return dl.call(this, t)
    }
    ,
    Gc.prototype.setCellValues = function(t, e, i, o) {
        return Wl.call(this, t, e, i, o)
    }
    ,
    Gc.prototype.fillCells = function(t, e, i) {
        return Kl.call(this, t, e, i)
    }
    ,
    Gc.prototype.deleteCols = function(t) {
        return Gl.call(this, t)
    }
    ,
    Gc.prototype.freezeCols = function(t) {
        return Zl.call(this, t)
    }
    ,
    Gc.prototype.hideCols = function(t) {
        return $l.call(this, t)
    }
    ,
    Gc.prototype.insertEmptyCols = function(t, e) {
        return eh.call(this, t, e)
    }
    ,
    Gc.prototype.moveCols = function(t, e) {
        return lh.call(this, t, e)
    }
    ,
    Gc.prototype.resizeCols = function(t, e) {
        return uh.call(this, t, e)
    }
    ,
    Gc.prototype.resizeColsToFit = function(t) {
        return ph.call(this, t)
    }
    ,
    Gc.prototype.deleteColsById = function(t) {
        return vh.call(this, t)
    }
    ,
    Gc.prototype.freezeColsUntilId = function(t) {
        return wh.call(this, t)
    }
    ,
    Gc.prototype.hideColsById = function(t) {
        return Ih.call(this, t)
    }
    ,
    Gc.prototype.showColsById = function(t) {
        return Lh.call(this, t)
    }
    ,
    Gc.prototype.deleteRows = function(t) {
        return kh.call(this, t)
    }
    ,
    Gc.prototype.freezeRows = function(t) {
        return Hh.call(this, t)
    }
    ,
    Gc.prototype.hideRows = function(t) {
        return zh.call(this, t)
    }
    ,
    Gc.prototype.insertEmptyRows = function(t, e) {
        return Fh.call(this, t, e)
    }
    ,
    Gc.prototype.moveRows = function(t, e) {
        return Oh.call(this, t, e)
    }
    ,
    Gc.prototype.deleteRowsById = function(t) {
        return Wh.call(this, t)
    }
    ,
    Gc.prototype.freezeRowsUntilId = function(t) {
        return Uh.call(this, t)
    }
    ,
    Gc.prototype.hideRowsById = function(t) {
        return $h.call(this, t)
    }
    ,
    Gc.prototype.showRowsById = function(t) {
        return Jh.call(this, t)
    }
    ,
    Gc.prototype.clearSearch = function() {
        return ta.call(this)
    }
    ,
    Gc.prototype.search = function(t) {
        return ia.call(this, t)
    }
    ,
    Gc.prototype.searchPrev = function() {
        return sa.call(this)
    }
    ,
    Gc.prototype.searchNext = function() {
        return oa.call(this)
    }
    ,
    Gc.prototype.sort = function(t, e) {
        return aa.call(this, t, e)
    }
    ,
    Gc.prototype.activate = function() {
        return da.call(this)
    }
    ,
    Gc.prototype.deactivate = function() {
        return ua.call(this)
    }
    ,
    Gc.prototype.getColCoordById = function(t) {
        return pa.call(this, t)
    }
    ,
    Gc.prototype.getColIdByCoord = function(t) {
        return fa.call(this, t)
    }
    ,
    Gc.prototype.getColIdByIndex = function(t) {
        return ga.call(this, t)
    }
    ,
    Gc.prototype.getColIndexByCoord = function(t) {
        return _a.call(this, t)
    }
    ,
    Gc.prototype.getColIndexById = function(t) {
        return ya.call(this, t)
    }
    ,
    Gc.prototype.getColPositionInViewport = function(t) {
        return va.call(this, t)
    }
    ,
    Gc.prototype.getColWidthById = function(t) {
        return ma.call(this, t)
    }
    ,
    Gc.prototype.getColSectionFromCellCoords = function(t) {
        return xa.call(this, t)
    }
    ,
    Gc.prototype.getPanePositionXfromCellCoords = function(t) {
        return wa.call(this, t)
    }
    ,
    Gc.prototype.getRowCoordById = function(t) {
        return Ca.call(this, t)
    }
    ,
    Gc.prototype.getRowHeightById = function(t) {
        return ba.call(this, t)
    }
    ,
    Gc.prototype.getRowIdByCoord = function(t) {
        return Sa.call(this, t)
    }
    ,
    Gc.prototype.getRowIdByIndex = function(t) {
        return Ia.call(this, t)
    }
    ,
    Gc.prototype.getRowIndexByCoord = function(t) {
        return Ra.call(this, t)
    }
    ,
    Gc.prototype.getRowIndexById = function(t) {
        return La.call(this, t)
    }
    ,
    Gc.prototype.getRowPositionInViewport = function(t) {
        return Pa.call(this, t)
    }
    ,
    Gc.prototype.getRowSectionFromCellCoords = function(t) {
        return Na.call(this, t)
    }
    ,
    Gc.prototype.getPanePositionYfromCellCoords = function(t) {
        return ka.call(this, t)
    }
    ,
    Gc.prototype.closeCellEditor = function() {
        return Ha.call(this)
    }
    ,
    Gc.prototype.closeCellEditorAndSave = function() {
        return za.call(this)
    }
    ,
    Gc.prototype.openCellEditor = function(t) {
        return Aa.call(this, t)
    }
    ,
    Gc.prototype.setCellEditorValue = function(t) {
    ...
    ,
    Gc.prototype.cut = function() {
        return Ma.call(this)
    }
    ,
    Gc.prototype.paste = function() {
        return Ba.call(this)
    }
    ,
    Gc.prototype.openContextMenu = function() {
        return Oa.call(this)
    }
    ,
    Gc.prototype.downloadDataAsCSV = function(t) {
        return Da.call(this, t)
    }
    ,
    Gc.prototype.downloadDataAsJSON = function(t) {
        return Xa.call(this, t)
    }
    ,
    Gc.prototype.getCellRangeData = function(t) {
        return Wa.call(this, t)
    }
    ,
    Gc.prototype.getCellRangeText = function(t) {
        return Ka.call(this, t)
    }
    ,
    Gc.prototype.getCellValue = function(t) {
        return ja.call(this, t)
    }
    ,
    Gc.prototype.getData = function(t) {
        return Ua.call(this, t)
    }
    ,
    Gc.prototype.toggleFullscreen = function() {
        return qa.call(this)
    }
    ,
    Gc.prototype.getSpreadsheetCoords = function(t) {
        return $a.call(this, t)
    }
    ,
    Gc.prototype.alertUser = function(t) {
        return Qa.call(this, t)
    }
    ,
    Gc.prototype.generateCssFromStyles = function() {
        return Ja.call(this)
    }
    ,
    Gc.prototype.redraw = function() {
        return ec.call(this)
    }
    ,
    Gc.prototype.resize = function() {
        return ic.call(this)
    }
    ,
    Gc.prototype.getLocaleSetting = function(t) {
        return oc.call(this, t)
    }
    ,
    Gc.prototype.deselectAll = function() {
        return nc.call(this)
    }
    ,
    Gc.prototype.getAnyRangesFromCellCoords = function(t) {
        return rc.call(this, t)
    }
    ,
    Gc.prototype.getSelection = function(t) {
        return lc.call(this, t)
    }
    ,
    Gc.prototype.selectAll = function(t) {
        return hc.call(this, t)
    }
    ,
    Gc.prototype.modifyActiveRange = function(t) {
        return ac.call(this, t)
    }
    ,
    Gc.prototype.getCellCursorPosition = function() {
        return pc.call(this)
    }
    ,
    Gc.prototype.setCellCursorPosition = function(t) {
        return fc.call(this, t)
    }
    ,
    Gc.prototype.moveCellCursor = function(t) {
        return gc.call(this, t)
    }
    ,
    Gc.prototype.moveCellCursorInsideSelection = function(t) {
        return _c.call(this, t)
    }
    ,
    Gc.prototype.moveCellCursorOneViewportUp = function() {
        return yc.call(this)
    }
    ,
    Gc.prototype.moveCellCursorOneViewportDown = function() {
        return vc.call(this)
    }
    ,
    Gc.prototype.moveCellCursorToColStart = function() {
        return mc.call(this)
    }
    ,
    Gc.prototype.moveCellCursorToColEnd = function() {
        return xc.call(this)
    }
    ,
    Gc.prototype.moveCellCursorToRowStart = function() {
        return wc.call(this)
    }
    ,
    Gc.prototype.moveCellCursorToRowEnd = function() {
        return Cc.call(this)
    }
    ,
    Gc.prototype.moveCellCursorToSheetStart = function() {
        return bc.call(this)
    }
    ,
    Gc.prototype.moveCellCursorToSheetEnd = function() {
        return Sc.call(this)
    }
    ,
    Gc.prototype.setCellSelection = function(t) {
        return Ic.call(this, t)
    }
    ,
    Gc.prototype.getCellSelection = function(t) {
        return Rc.call(this, t)
    }
    ,
    Gc.prototype.setCellRangeExtreme = function(t, e) {
        return Lc.call(this, t, e)
    }
    ,
    Gc.prototype.addCellRangeToSelection = function(t) {
        return Pc.call(this, t)
    }
    ,
    Gc.prototype.getColRangesFromCoord = function(t) {
        return Nc.call(this, t)
    }
    ,
    Gc.prototype.getColSelection = function(t) {
        return kc.call(this, t)
    }
    ,
    Gc.prototype.setColSelection = function(t) {
        return Hc.call(this, t)
    }
    ,
    Gc.prototype.setColRangeExtreme = function(t, e) {
        return Ac.call(this, t, e)
    }
    ,
    Gc.prototype.addColRangeToSelection = function(t) {
        return Tc.call(this, t)
    }
    ,
    Gc.prototype.getRowRangesFromCoord = function(t) {
        return Fc.call(this, t)
    }
    ,
    Gc.prototype.getRowSelection = function(t) {
        return Ec.call(this, t)
    }
    ,
    Gc.prototype.setRowSelection = function(t) {
        return Mc.call(this, t)
    }
    ,
    Gc.prototype.setRowRangeExtreme = function(t, e) {
        return Oc.call(this, t, e)
    }
    ,
    Gc.prototype.addRowRangeToSelection = function(t) {
        return Dc.call(this, t)
    }
    ,
    Gc.prototype.getCellFromStore = function(t, e) {
        return Vc.call(this, t, e)
    }
    ,
    Gc.prototype.getColFromStore = function(t) {
        return Xc.call(this, t)
    }
    ,
    Gc.prototype.getRowFromStore = function(t) {
        return Yc.call(this, t)
    }
    ,
    Gc.prototype.getThemeSetting = function(t) {
        return Wc.call(this, t)
    }
    ,
    Gc.prototype.undo = function() {
        return Kc.call(this)
    }
    ,
    Gc.prototype.redo = function() {
        return jc.call(this)
    }
    ,
    Gc.prototype.getViewportPosition = function() {
        return Uc.call(this)
    }
    ,
    Gc.prototype.setViewportPosition = function(t) {
    ...
    Gc._isMacOS = navigator.platform.indexOf("Mac") > -1,
    Gc._isIOS = !!navigator.platform && /iPad|iPhone|iPod/.test(navigator.platform) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1,
    Gc._isTouchDevice = window.matchMedia("(pointer: coarse)").matches,
    Gc.createEmptyData = function(t, e) {
        for (var i = [], o = 0; o < t; o++) {
            i.push([]);
            for (var s = 0; s < e; s++)
                i[o].push(null)
    ...
    ,
    Gc.createDummyData = function(t, e) {
        for (var i = [], o = 0; o < t; o++) {
            i.push([]);
            for (var s = 0; s < e; s++)
                i[o].push(o + 1 + ";" + (s + 1))
